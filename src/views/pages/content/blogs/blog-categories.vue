...
export default {
  ...
  data() {
    return {
      ...
      text: "Content",
      text1: "Blog Categories",
      BlogCate: ["Active", "Inactive"],
      EditBlogCate: ["Active", "Inactive"],
    };
  },
  methods: {
    submitForm() {
      this.$router.push("/blog/blog-categories");
    },
    toggleHeader() {
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <vue-select :options="BlogCate" id="blogcate" placeholder="Active" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="modal-body pb-0">
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Status</label>
                  <vue-select :options="EditBlogCate" id="editblogcate" placeholder="Active" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="modal-content">
        <div class="modal-body text-center">
          ...
          <div class="d-flex justify-content-center">
            ...
            <router-link to="/blog/blog-categories" class="btn btn-danger">Yes, Delete</router-link>
          </div>
        </div>
      </div>
    </div>
