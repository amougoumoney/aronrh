        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
          <div class="mb-2">
            <a
              ...
              ><i class="ti ti-circle-plus me-2"></i>Add Blog</a
            >
          </div>
          ...
          <div class="card">
            <div class="card-body">
              <div class="img-sec w-100 position-relative mb-3">
                ...
                <div class="">
                  <router-link
                    to="/blog/blog-categories"
                    class="trend-tag badge bg-info-transparent fs-10 fw-medium"
                    >Evlovution</router-link
                  >
                  <span class="badge badge-success dot-icon"
              ...
              <div class="d-flex align-items-center justify-content-between mb-3">
                <div class="d-flex align-items-center">
                  <span class="me-2 d-flex align-items-center"
                    ><i class="ti ti-calendar me-1"></i> 05 Oct 2024</span
                  >
                  <a
                    href="javascript:void(0);"
                    class="border-start link-default fs-14 fw-normal ps-2 me-2 text-truncate"
                    ><img
              ...
              <div class="border-bottom mb-3">
                <h5 class="mb-3">
                  <router-link
                    to="/blog/blog-categories"
                    class="fs-16 fw-medium text-truncate"
                    >The Evolution of HRMS: Manual to Digital</router-link
                  >
                </h5>
              </div>
              ...
              <div class="border-bottom mb-3">
                <h5 class="mb-3">
                  <router-link
                    to="/blog/blog-categories"
                    class="fs-16 fw-medium text-truncate"
                    >HRMS Implementation: Step-by-Step Guide</router-link
                  >
                </h5>
              </div>
              <div class="d-flex align-items-center justify-content-between text-center">
              ...
              <div class="border-bottom mb-3">
                <h5 class="mb-3">
                  <router-link
                    ...
                    class="fs-16 fw-medium text-truncate"
                  >
                    Data Security in HRMS: What Matters</router-link
                  >
                </h5>
              </div>
              <div class="d-flex align-items-center justify-content-between text-center">
              ...
              <div class="border-bottom mb-3">
                <h5 class="mb-3">
                  <router-link
                    ...
                    class="fs-16 fw-medium text-truncate"
                  >
                    Improving Recruitment with HRMS</router-link
                  >
                </h5>
              </div>
              <div class="d-flex align-items-center justify-content-between text-center">
              ...
              <div class="border-bottom mb-3">
                <h5 class="mb-3">
                  <router-link
                    ...
                    class="fs-16 fw-medium text-truncate"
                  >
                    Impact of HRMS on Company Culture</router-link
                  >
                </h5>
              </div>
              <div class="d-flex align-items-center justify-content-between text-center">
              ...
              <div class="border-bottom mb-3">
                <h5 class="mb-3">
                  <router-link
                    to="/blog/blog-categories"
                    class="fs-16 fw-medium text-truncate"
                    >Key Benefits of Implementing HRMS</router-link
                  >
                </h5>
              </div>
              <div class="d-flex align-items-center justify-content-between text-center">
              ...
              <div class="border-bottom mb-3">
                <h5 class="mb-3">
                  <router-link
                    to="/blog/blog-categories"
                    class="fs-16 fw-medium text-truncate"
                    >Why Your Company Needs a HRMS</router-link
                  >
                </h5>
              </div>
              <div class="d-flex align-items-center justify-content-between text-center">
              ...
              <div class="border-bottom mb-3">
                <h5 class="mb-3">
                  <router-link
                    to="/blog/blog-categories"
                    class="fs-16 fw-medium text-truncate"
                    >Scaling Your HR Operations with HRMS</router-link
                  >
                </h5>
              </div>
              <div class="d-flex align-items-center justify-content-between text-center">
              ...
              <div class="border-bottom mb-3">
                <h5 class="mb-3">
                  <router-link
                    to="/blog/blog-categories"
                    class="fs-16 fw-medium text-truncate"
                    >How HRMS Drives Organizational Success</router-link
                  >
                </h5>
              </div>
              <div class="d-flex align-items-center justify-content-between text-center">
