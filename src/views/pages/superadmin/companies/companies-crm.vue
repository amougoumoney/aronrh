        ...
        <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
          ...
          <div class="d-flex my-xl-auto right-content align-items-center flex-wrap row-gap-3">
            ...
            <div class="dropdown me-3">
              ...
              <ul class="dropdown-menu dropdown-menu-end p-3">
                <li>
                  <a href="#" class="dropdown-item rounded-1">BrightWave Innovations
                  </a>
                </li>
                <li>
                  <a href="#" class="dropdown-item rounded-1">Quantum Nexus</a>
                </li>
                <li>
                  <a href="#" class="dropdown-item rounded-1">TerraFusion Energy</a>
                </li>
              </ul>
            </div>
            <div class="dropdown me-3">
              ...
              <ul class="dropdown-menu dropdown-menu-end p-3">
                <li>
                  <a href="#" class="dropdown-item rounded-1">Hendry</a>
                </li>
                <li>
                  <a href="#" class="dropdown-item rounded-1">Jami</a>
                </li>
                <li>
                  <a href="#" class="dropdown-item rounded-1">Newell</a>
                </li>
              </ul>
            </div>
            <div class="dropdown me-3">
