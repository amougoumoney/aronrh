          ...
          <div class="card flex-fill">
            ...
            <div class="card-body">
              <div id="company-chart">
                <apexchart type="bar" height="240" :options="companyChart.company" :series="companyChart.series">
                </apexchart>
              </div>
          ...
          <div class="card flex-fill">
            ...
            <div class="card-body pb-0">
              ...
              <div id="revenue-income">
                <apexchart type="bar" height="230" :options="revenueCharts.income" :series="revenueCharts.series">
                </apexchart>
              </div>
            </div>
          </div>
                ...
                <div class="d-flex align-items-center mb-2">
                  ...
                  <div class="ms-2 flex-fill">
                    ...
                    <p class="fs-13 d-inline-flex align-items-center">
                      <span class="text-info">#12457</span><i class="ti ti-circle-filled fs-4 text-primary mx-1"></i>14
                      Jan
                      2025
                    </p>
                  </div>
              ...
              <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                <div class="d-flex align-items-center mb-2">
                  ...
                  <div class="ms-2 flex-fill">
                    ...
                    <p class="fs-13 d-inline-flex align-items-center">
                      <span class="text-info">#65974</span><i class="ti ti-circle-filled fs-4 text-primary mx-1"></i>14
                      Jan
                      2025
                    </p>
                  </div>
              ...
              <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                <div class="d-flex align-items-center mb-2">
                  ...
                  <div class="ms-2 flex-fill">
                    ...
                    <p class="fs-13 d-inline-flex align-items-center">
                      <span class="text-info">#22457</span><i class="ti ti-circle-filled fs-4 text-primary mx-1"></i>14
                      Jan
                      2025
                    </p>
                  </div>
              ...
              <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                <div class="d-flex align-items-center mb-2">
                  ...
                  <div class="ms-2 flex-fill">
                    ...
                    <p class="fs-13 d-inline-flex align-items-center">
                      <span class="text-info">#43412</span><i class="ti ti-circle-filled fs-4 text-primary mx-1"></i>14
                      Jan
                      2025
                    </p>
                  </div>
              ...
              <div class="d-sm-flex justify-content-between flex-wrap mb-1">
                <div class="d-flex align-items-center mb-2">
                  ...
                  <div class="ms-2 flex-fill">
                    ...
                    <p class="fs-13 d-inline-flex align-items-center">
                      <span class="text-info">#43567</span><i class="ti ti-circle-filled fs-4 text-primary mx-1"></i>14
                      Jan
                      2025
                    </p>
                  </div>
