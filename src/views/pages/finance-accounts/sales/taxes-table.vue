...
<template>
    <a-table class="table datatable thead-light" 
        :columns="columns"  
        :data-source="data" 
        ...
        <template #bodyCell="{ column, record }">
            <template v-if="column.key === 'Tax_Name'">
                <div class="d-flex align-items-center">
                    ...
                    <a href="javascript:void(0);" class="text-info" data-bs-toggle="tooltip" data-bs-placement="right" title="Comprehensive tax on the supply of goods and services.">
                ...
                <div class="dropdown">
                    <a href="javascript:void(0);" class="dropdown-toggle btn btn-sm btn-white d-inline-flex align-items-center" data-bs-toggle="dropdown">
                        ...
                        >
                            ...
                            :class="[record.Status === 'Active' ? 'text-success' : 'text-danger']"
                            ></i>
                        </span> {{record.Status}}
                    </a>
            ...
            <template v-if="column.key === 'action'">
                <div class="action-icon d-inline-flex">
                    <a href="javascript:void(0);" class="me-2" data-bs-toggle="modal" data-bs-target="#edit_tax"><i class="ti ti-edit"></i></a>
