        ...
        <template #bodyCell="{ column, record }">
            <template v-if="column.key === 'Tax_Name'">
                <div class="d-flex align-items-center">
                    ...
                    <a href="javascript:void(0);" class="text-info" data-bs-toggle="tooltip" data-bs-placement="right"
            ...
            <template v-if="column.key === 'action'">
                <div class="action-icon d-inline-flex">
                    <a href="javascript:void(0);" class="me-2" data-bs-toggle="modal" data-bs-target="#edit_tax"><i
