        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
          <div class="mb-2">
            <a href="#" data-bs-toggle="modal" data-bs-target="#add_new_expense"
              class="btn btn-primary d-flex align-items-center"><i class="ti ti-circle-plus me-2"></i>Add Expense</a>
          </div>
            ...
            <a-table class="table datatable thead-light" :columns="columns" :data-source="data"
              ...
              <template #bodyCell="{ column, record }">
                <template v-if="column.key === 'ExpenseName'">
                  <h6 class="fw-medium">
                    <a href="#">{{ record.ExpenseName }}</a>
                  </h6>
                </template>
                <template v-if="column.key === 'action'">
                  <div class="action-icon d-inline-flex">
                    <a href="#" class="me-2" data-bs-toggle="modal" data-bs-target="#edit_new_expense"><i
