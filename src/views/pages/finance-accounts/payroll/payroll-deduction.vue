<template>
    ...
    <div class="content">
      ...
      <div class="d-flex justify-content-between my-4">
        <div class="payroll-btns">
          <router-link to="/payroll/payroll" class="btn btn-white border me-2">{{ $t('Additions') }}</router-link>
          <router-link to="/payroll/payroll-overtime" class="btn btn-white border me-2">{{ $t('Overtime') }}</router-link>
          <router-link to="/payroll/payroll-deduction" class="btn btn-white active border">{{ $t('Deductions') }}</router-link>
        </div>
        <div class="mb-2">
          <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#add_deduction"
            class="btn btn-primary d-flex align-items-center"><i class="ti ti-circle-plus me-2"></i>{{ $t('AddDeduction') }}</a>
        </div>
      </div>
        ...
        <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
          ...
          <div class="d-flex my-xl-auto right-content align-items-center flex-wrap row-gap-3">
            <div class="dropdown me-3">
              ...
              <ul class="dropdown-menu dropdown-menu-end p-3">
                <li>
                  <a href="javascript:void(0);" class="dropdown-item rounded-1">{{ $t('MonthlyRemuneration') }}</a>
                </li>
                <li>
                  <a href="javascript:void(0);" class="dropdown-item rounded-1">{{ $t('AdditionalRemuneration') }}</a>
                </li>
                <li>
                  <a href="javascript:void(0);" class="dropdown-item rounded-1">{{ $t('MonthlyRemuneration') }}</a>
                </li>
                ...
                <template v-if="column.key === 'action'">
                  <div class="action-icon d-inline-flex">
                    <a href="javascript:void(0);" class="me-2" data-bs-toggle="modal"
                      data-bs-target="#edit_deduction"><i class="ti ti-edit"></i></a>
  ...
  <!-- /Page Wrapper -->
  <payroll-deduction-modal></payroll-deduction-modal>
</template>
<script>
const columns = [
  {
