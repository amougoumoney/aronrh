...
<template>
    ...
    <div class="content">
      ...
      <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
          <div class="mb-2">
            <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#add_training_type"
              class="btn btn-primary d-flex align-items-center"><i class="ti ti-circle-plus me-2"></i>{{$t('AddTrainingType')}}
              </a>
          </div>
      ...
      <div class="card">
        ...
        <div class="card-body p-0">
          <div class="custom-datatable-filter table-responsive">
            <training-type-table></training-type-table>
          </div>
        </div>
      </div>
      <!-- /Performance Indicator list -->
  ...
  <training-type-modal></training-type-modal>
</template>
