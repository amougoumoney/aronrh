...
export default {
  setup() {
    ...
    const layoutType = computed(() => {
      return route.path === "/layouts/layout-box" ? "default" : "";
    });

    // Compute the width type (data-width attribute)
    const layoutWidth = computed(() => {
      return route.path === "/layouts/layout-box" ? "box" : "default";
    });
    ...
    const updateHtmlAndBody = () => {
      ...
      // Update the <html> element's data-width attribute
      if (width) {
