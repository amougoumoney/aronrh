...
import { mySemiDonutChartjs } from "./data";

export default {
  data() {
    return {
      mySemiDonutChartjs: mySemiDonutChartjs,
    };
  },
  components: {
    Vue3ChartJs,
          ...
          <div class="table-responsive">
            <table class="table table-nowrap mb-0">
              ...
              <tbody>
                <tr>
                  <td>
                    <router-link to="/projects/projects-details" class="link-default">PRO-001</router-link>
                  </td>
                  <td>
                    <h6 class="fw-medium">
                      <router-link to="/projects/projects-details">Office Management App</router-link>
                    </h6>
                  </td>
                  <td>
                  ...
                  <td>
                    ...
                    <div class="progress progress-xs w-100" role="progressbar" aria-valuenow="40" aria-valuemin="0"
                      aria-valuemax="100">
                  ...
                  <td>
                    <span class="badge badge-danger d-inline-flex align-items-center badge-xs">
                      <i class="ti ti-point-filled ms-1"></i>High
                    </span>
                  </td>
                </tr>
                <tr>
                  <td>
                    <router-link to="/projects/projects-details" class="link-default">PRO-002</router-link>
                  </td>
                  <td>
                    <h6 class="fw-medium">
                      <router-link to="/projects/projects-details">Clinic Management
                      </router-link>
                    </h6>
                  </td>
                  <td>
                  ...
                  <td>
                    <span class="badge badge-success d-inline-flex align-items-center badge-xs">
                      <i class="ti ti-point-filled ms-1"></i>Low
                    </span>
                  </td>
                </tr>
                <tr>
                  <td>
                    <router-link to="/projects/projects-details" class="link-default">PRO-003</router-link>
                  </td>
                  <td>
                    <h6 class="fw-medium">
                  ...
                  <td>
                    ...
                    <div class="progress progress-xs w-100" role="progressbar" aria-valuenow="50" aria-valuemin="0"
                      aria-valuemax="100">
                  ...
                  <td>
                    <span class="badge badge-pink d-inline-flex align-items-center badge-xs">
                      <i class="ti ti-point-filled ms-1"></i>Medium
                    </span>
                  </td>
                </tr>
                <tr>
                  <td>
                    <router-link to="/projects/projects-details" class="link-default">PRO-004</router-link>
                  </td>
                  <td>
                    <h6 class="fw-medium">
                      <router-link to="/projects/projects-details">Chat & Call Mobile App</router-link>
                    </h6>
                  </td>
                  <td>
                    <div class="avatar-list-stacked avatar-group-sm">
                ...
                <tr>
                  <td>
                    <router-link to="/projects/projects-details" class="link-default">PRO-005</router-link>
                  </td>
                  <td>
                    <h6 class="fw-medium">
                ...
                <tr>
                  <td>
                    <router-link to="/projects/projects-details" class="link-default">PRO-006</router-link>
                  </td>
                  <td>
                    <h6 class="fw-medium">
                ...
                <tr>
                  <td class="border-0">
                    <router-link to="/projects/projects-details" class="link-default">PRO-008</router-link>
                  </td>
                  <td class="border-0">
                    <h6 class="fw-medium">
                      <router-link to="/projects/projects-details">Travel Planning Website</router-link>
                  ...
                  <td class="border-0">
                    <p class="mb-1">15/255 Hrs</p>
                    <div class="progress progress-xs w-100" role="progressbar" aria-valuenow="45" aria-valuemin="0"
                      aria-valuemax="100">
      ...
      <div class="card flex-fill">
        ...
        <div class="card-body">
          <div class="chartjs-wrapper-demo position-relative mb-4">
            <vue3-chart-js id="mySemiDonutChart" class="chartjs-chart" height="200"
              v-bind="{ ...mySemiDonutChartjs }"></vue3-chart-js>
          ...
          <div class="d-flex align-items-center flex-wrap">
            <div class="border-end text-center ms-2 pe-2 mb-3">
              <p class="fs-13 d-inline-flex align-items-center mb-1">
                <i class="ti ti-circle-filled fs-10 ms-1 text-warning"></i>Ongoing
              </p>
              <h5>24%</h5>
            </div>
            <div class="border-end text-center ms-2 pe-2 mb-3">
              <p class="fs-13 d-inline-flex align-items-center mb-1">
                <i class="ti ti-circle-filled fs-10 ms-1 text-info"></i>On Hold
              </p>
              <h5>10%</h5>
            </div>
            <div class="border-end text-center ms-2 pe-2 mb-3">
              <p class="fs-13 d-inline-flex align-items-center mb-1">
                <i class="ti ti-circle-filled fs-10 ms-1 text-danger"></i>Overdue
              </p>
              <h5>16%</h5>
            </div>
            <div class="text-center ms-2 pe-2 mb-3">
              <p class="fs-13 d-inline-flex align-items-center mb-1">
                <i class="ti ti-circle-filled fs-10 ms-1 text-success"></i>Ongoing
              </p>
              <h5>40%</h5>
            </div>
          </div>
          <div class="bg-dark br-5 p-3 pb-0 d-flex align-items-center justify-content-between">
            ...
            <router-link to="/projects/tasks" class="btn btn-sm btn-light mb-2 text-nowrap">View All</router-link>
          </div>
        </div>
      </div>
    </div>
