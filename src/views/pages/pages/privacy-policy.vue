    ...
    <div class="content">
      ...
      <div class="card">
        <div class="card-body">
          <div class="mb-3">
            <p>
              At SmratHR, we value your privacy and are committed to protecting your
              personal data. This Privacy Policy explains how we collect, use, disclose,
              and safeguard your information when you access our HR admin platform. Please
          ...
          <div>
            ...
            <ul class="list-styled mb-3">
              <li class="d-flex align-items-baseline mb-2">
                ...
                <span class="fw-medium text-gray-9 me-1">Employee Data :</span>Name,
                contact information, job title, department, payroll details, and other
                employment-related data.
              </li>
              <li class="d-flex align-items-baseline mb-2">
                <i class="ti ti-point-filled fs-10 me-1"></i>
                <span class="fw-medium text-gray-9 me-1">Login Information :</span>Username, password, IP address, and
                other access credentials.
              </li>
              <li class="d-flex align-items-baseline">
                <i class="ti ti-point-filled fs-10 me-1"></i>
                <span class="fw-medium text-gray-9 me-1">Usage Data : </span>Details about
                how the platform is used, including logs of actions taken within the HR
                admin module
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              be available on the platform. Continued use of the HR admin platform
