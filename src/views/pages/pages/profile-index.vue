              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="row align-items-center mb-3">
                    ...
                    <div class="col-md-8">
                      <div>
                        <vue-select :options="TurkPro" id="turkpro" placeholder="Select" />
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="row align-items-center mb-3">
                    ...
                    <div class="col-md-7">
                      <div class="pass-group">
                        <input :type="showPassword2 ? 'text' : 'password'" class="pass-inputs form-control"
                          placeholder="Confirm Password" />
                        <span @click="toggleShow2" class="ti toggle-passwords" :class="{
