        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
          <div class="me-2 mb-2">
            ...
            <div class="d-flex align-items-center border bg-white rounded p-1 me-2">
              <router-link to="/recuritment/job-list" class="btn btn-icon btn-sm active bg-primary text-white me-1"><i
                  class="ti ti-list-tree"></i></router-link>
              <router-link to="/recuritment/job-grid" class="btn btn-icon btn-sm"><i
          ...
          <div class="d-flex my-xl-auto right-content align-items-center flex-wrap row-gap-3">
            ...
            <div class="dropdown me-3">
              ...
              <ul class="dropdown-menu dropdown-menu-end p-3">
                ...
                <li>
                  <a href="#" class="dropdown-item rounded-1">sent</a>
                </li>
                <li>
                  <a href="#" class="dropdown-item rounded-1">Expired</a>
                </li>
                <li>
                  <a href="#" class="dropdown-item rounded-1">Declined</a>
                </li>
              </ul>
            </div>
            <div class="dropdown">
