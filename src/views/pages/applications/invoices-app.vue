    ...
    <div class="content">
      ...
      <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
          ...
          <div class="mb-2">
            <router-link to="/applications/add-invoices" class="btn btn-primary d-flex align-items-center"><i
                ...
                <table class="table datatable">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <router-link to="/applications/invoice-details" class="tb-data">INV-1454</router-link>
                      </td>
                      <td>
                        <div class="d-flex align-items-center">
                          ...
                          <div>
                            <h6 class="fw-medium">
                              <router-link to="/applications/invoice-details">Anthony Lewis</router-link>
                            </h6>
                      ...
                      <td>
                        <div class="action-icon d-inline-flex">
                          <router-link to="/applications/invoice-details" class="me-2"><i
                              class="ti ti-eye"></i></router-link>
                          <router-link to="/applications/edit-invoices" class="me-2"><i
                              class="ti ti-edit"></i></router-link>
                          <a href="#delete_modal" class="" data-bs-toggle="modal" data-bs-target="#delete_modal"><i
                    ...
                    <tr>
                      ...
                      <td>
                        <router-link to="/applications/invoice-details" class="tb-data">INV-6571</router-link>
                      </td>
                      <td>
                        <div class="d-flex align-items-center">
                          <router-link to="/applications/invoice-details"
                          ...
                          <div>
                            <h6 class="fw-medium">
                              <router-link to="/applications/invoice-details">Brian Villalobos</router-link>
                            </h6>
                    ...
                    <tr>
                      ...
                      <td>
                        <router-link to="/applications/invoice-details" class="tb-data">INV-2245</router-link>
                      </td>
                      <td>
                        <div class="d-flex align-items-center">
                          <router-link to="/applications/invoice-details"
                          ...
                          <div>
                            <h6 class="fw-medium">
                              <router-link to="/applications/invoice-details">Harvey Smith</router-link>
                            </h6>
                    ...
                    <tr>
                      ...
                      <td>
                        <router-link to="/applications/invoice-details" class="tb-data">INV-1456</router-link>
                      </td>
                      <td>
                        <div class="d-flex align-items-center">
                          <router-link to="/applications/invoice-details"
                          ...
                          <div>
                            <h6 class="fw-medium">
                              <router-link to="/applications/invoice-details">Stephan Peralt</router-link>
                            </h6>
                      ...
                      <td>
                        <div class="action-icon d-inline-flex">
                          ...
                          <a href="#" class="" data-bs-toggle="modal" data-bs-target="#delete_modal"><i
                              class="ti ti-trash"></i></a>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <router-link to="/applications/invoice-details" class="tb-data">INV-0045</router-link>
                      </td>
                      <td>
                        <div class="d-flex align-items-center">
                          <router-link to="/applications/invoice-details"
                          ...
                          <div>
                            <h6 class="fw-medium">
                              <router-link to="/applications/invoice-details">Doglas Martini</router-link>
                            </h6>
                    ...
                    <tr>
                      ...
                      <td>
                        <router-link to="/applications/invoice-details" class="tb-data">INV-6244</router-link>
                      </td>
                      <td>
                        <div class="d-flex align-items-center">
                          <router-link to="/applications/invoice-details"
                          ...
                          <div>
                            <h6 class="fw-medium">
                              <router-link to="/applications/invoice-details">Linda Ray</router-link>
                            </h6>
                    ...
                    <tr>
                      ...
                      <td>
                        <router-link to="/applications/invoice-details" class="tb-data">INV-9565</router-link>
                      </td>
                      <td>
                        <div class="d-flex align-items-center">
                          <router-link to="/applications/invoice-details"
                          ...
                          <div>
                            <h6 class="fw-medium">
                              <router-link to="/applications/invoice-details">Elliot Murray</router-link>
                            </h6>
                    ...
                    <tr>
                      ...
                      <td>
                        <router-link to="/applications/invoice-details" class="tb-data">INV-6874</router-link>
                      </td>
                      <td>
                        <div class="d-flex align-items-center">
                          <router-link to="/applications/invoice-details"
                          ...
                          <div>
                            <h6 class="fw-medium">
                              <router-link to="/applications/invoice-details">Rebecca Smtih</router-link>
                            </h6>
                    ...
                    <tr>
                      ...
                      <td>
                        <router-link to="/applications/invoice-details" class="tb-data">INV-6587</router-link>
                      </td>
                      <td>
                        <div class="d-flex align-items-center">
                          <router-link to="/applications/invoice-details"
                          ...
                          <div>
                            <h6 class="fw-medium">
                              <router-link to="/applications/invoice-details">Connie Waters</router-link>
                            </h6>
                    ...
                    <tr>
                      ...
                      <td>
                        <router-link to="/applications/invoice-details" class="tb-data">INV-5879</router-link>
                      </td>
                      <td>
                        <div class="d-flex align-items-center">
                          <router-link to="/applications/invoice-details"
                          ...
                          <div>
                            <h6 class="fw-medium">
                              <router-link to="/applications/invoice-details">Lori Broaddus</router-link>
                            </h6>
        ...
        <div class="modal-content">
          <div class="modal-body text-center">
            ...
            <div class="d-flex justify-content-center">
              ...
              <router-link to="/applications/invoices" class="btn btn-danger">Yes, Delete</router-link>
            </div>
          </div>
        </div>
      </div>
