<template>
          ...
          <div class="active slimscroll h-100">
            <div class="slimscroll-active-sidebar">
              <div class="p-3">
                ...
                <a href="#" class="btn btn-primary w-100" data-bs-toggle="modal" data-bs-target="#compose_mail"><i
              ...
              <div
                ...
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end p-3">
                    <li>
                      <a class="dropdown-item rounded-1" href="#">Peoples</a>
                    </li>
                    <li>
                      <a class="dropdown-item rounded-1" href="#">Rufana</a>
                    </li>
                    <li>
                      <a class="dropdown-item rounded-1" href="#">Sean Hill</a>
                    </li>
                    <li>
                      <a class="dropdown-item rounded-1" href="#">Cameron Drake</a>
                    </li>
                  </ul>
                </div>
                <div class="d-flex align-items-center">
                  <a href="#" class="btn btn-icon btn-sm rounded-circle"><i class="ti ti-arrow-back-up"></i></a>
                  <a href="#" class="btn btn-icon btn-sm rounded-circle"><i class="ti ti-arrow-back-up-double"></i></a>
              ...
              <div class="card shadow-none">
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center justify-content-between my-3 pt-3 border-top">
                    <h5>Attachments</h5>
                    <a href="#" class="text-primary fw-medium">Download All</a>
                  </div>
                            ...
                            <div class="d-flex align-items-center">
                              ...
                              <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                  <li>
                                    <a class="dropdown-item" href="#"><span class="text-gray">From
                                        :</span> Arman Janes
                                      arman343@example.com</a>
                                  </li>
                                  <li>
                                    <a class="dropdown-item" href="#"><span class="text-gray">To
                                        :</span> Angela Thomas
                                      ange4565@example.com</a>
                                  </li>
                                  <li>
                                    <a class="dropdown-item" href="#"><span class="text-gray">Date
                                        :</span> 12 May 2025,
                                      09:45 PM
                                    </a>
                                  </li>
                  ...
                  <form @submit.prevent="submitForm">
                    <div class="border rounded mt-3">
                      ...
                      <div class="d-flex align-items-center justify-content-between border-top p-3">
                        <div class="d-flex align-items-center">
                          <a href="#" class="btn btn-icon btn-sm rounded-circle"><i class="ti ti-paperclip"></i></a>
                          ...
                          <a href="#" class="btn btn-icon btn-sm rounded-circle"><i class="ti ti-pencil"></i></a>
                          <a href="#" class="btn btn-icon btn-sm rounded-circle"><i class="ti ti-mood-smile"></i></a>
                        </div>
                        <div class="d-flex align-items-center">
                          <a href="#" class="btn btn-icon btn-sm rounded-circle"><i
  ...
  <div class="modal fade" id="compose_mail" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content border-0">
        <div class="modal-header justify-content-between bg-dark">
          <h5 class="modal-title text-white">Compose New Email</h5>
          <div class="d-flex align-items-center">
            <a href="#" class="d-inline-flex me-2 text-white fs-16"><i class="ti ti-minus"></i></a>
            <a href="#" class="d-inline-flex me-2 fs-16 text-white"><i class="ti ti-maximize"></i></a>
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="modal-footer justify-content-between">
            ...
            <div class="d-flex align-items-center">
              <a href="#" class="btn btn-icon btn-sm rounded-circle"><i class="ti ti-calendar-repeat"></i></a>
              <a href="#" class="btn btn-icon btn-sm rounded-circle"><i class="ti ti-trash"></i></a>
              <button type="submit" class="btn btn-primary d-inline-flex align-items-center ms-2">
                Send <i class="ti ti-arrow-right ms-2"></i>
              </button>
...
export default {
  ...
  methods: {
    submitForm() {
      this.$router.push("/applications/email");
    },
  },
};
</script>
