              ...
              <div class="list-group list-group-flush mails-list">
                <div class="list-group-item border-bottom p-3">
                  <div class="d-flex align-items-center mb-2">
                    ...
                    <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                      <a href="/applications/email-reply" class="avatar bg-purple avatar-rounded me-2">
                      ...
                      <div class="flex-fill">
                        <div class="d-flex align-items-start justify-content-between">
                          <div>
                            <h6 class="mb-1">
                              <router-link to="/applications/email-reply">Justin Lapointe</router-link>
                            </h6>
                          ...
                          <div class="d-flex align-items-center">
                            <div class="dropdown">
                              ...
                              <ul class="dropdown-menu dropdown-menu-end p-3">
                                <li>
                                  <router-link class="dropdown-item rounded-1" to="/applications/email-reply">Open
                                    Email</router-link>
                                </li>
                                <li>
                            ...
                            <span><i class="ti ti-point-filled text-success"></i>3:13
                              PM</span>
                          </div>
                        </div>
                ...
                <div class="list-group-item border-bottom p-3">
                  <div class="d-flex align-items-center mb-2">
                    ...
                    <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                      <a href="/applications/email-reply" class="avatar avatar-md avatar-rounded me-2">
                      ...
                      <div class="flex-fill">
                        <div class="d-flex align-items-start justify-content-between">
                          <div>
                            <h6 class="mb-1">
                              <router-link to="/applications/email-reply">Rufana</router-link>
                            </h6>
                    ...
                    <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                      ...
                      <div class="flex-fill">
                        <div class="d-flex align-items-start justify-content-between">
                          <div>
                            <h6 class="mb-1">
                              <router-link to="/applications/email-reply">Cameron Drake</router-link>
                            </h6>
                ...
                <div class="list-group-item border-bottom p-3">
                  <div class="d-flex align-items-center mb-2">
                    ...
                    <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                      <router-link to="/applications/email-reply" class="avatar avatar-md avatar-rounded me-2">
                      ...
                      <div class="flex-fill">
                        <div class="d-flex align-items-start justify-content-between">
                          <div>
                            <h6 class="mb-1">
                              <router-link to="/applications/email-reply">Sean Hill</router-link>
                            </h6>
                    ...
                    <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                      ...
                      <div class="flex-fill">
                        <div class="d-flex align-items-start justify-content-between">
                          <div>
                            <h6 class="mb-1">
                              <router-link to="/applications/email-reply">Kevin Alley</router-link>
                            </h6>
                    ...
                    <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                      ...
                      <div class="flex-fill">
                        <div class="d-flex align-items-start justify-content-between">
                          <div>
                            <h6 class="mb-1">
                              <router-link to="/applications/email-reply">Linda Zimmer</router-link>
                            </h6>
                ...
                <div class="list-group-item border-bottom p-3">
                  <div class="d-flex align-items-center mb-2">
                    ...
                    <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                      <a href="/applications/email-reply" class="avatar bg-success avatar-rounded me-2">
                      ...
                      <div class="flex-fill">
                        <div class="d-flex align-items-start justify-content-between">
                          <div>
                            <h6 class="mb-1">
                              <router-link to="/applications/email-reply">Emly Reachel</router-link>
                            </h6>
