                ...
                <div class="row">
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="mb-3">
                      ...
                      <vue-select :options="DebiSel" id="debisel" placeholder="Select" />
                    </div>
                  </div>
                  <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="mb-3">
                      <label class="form-label">Bank Details</label>
                      <vue-select :options="AmerDe" id="amerde" placeholder="Select" />
                    </div>
                  </div>
                </div>
              </div>
...
export default {
  data() {
    return {
      ...
      DebiSel: ["Select", "Credit", "Debit"],
      AmerDe: ["Select", "Bank of America", "U.S.Bank"],
