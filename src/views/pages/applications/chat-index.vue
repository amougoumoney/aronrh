      ...
      <div class="chat-wrapper">
        ...
        <div class="sidebar-group">
          <div id="chats" class="sidebar-content active slimscroll">
            <perfect-scrollbar class="scroll-area-one" :settings="settings" @ps-scroll-y="scrollHanle">
                      ...
                      <router-link to="/applications/chat" class="chat-user-list">
                        ...
                        <div class="chat-user-info">
                          <div class="chat-user-msg">
                            ...
                            <p class="text-danger">
                              <i class="ti ti-video-off me-2"></i>Missed Video Call
                            </p>
                          </div>
                          <div class="chat-user-time">
                        ...
                        <div class="chat-user-info">
                          <div class="chat-user-msg">
                            ...
                            <p class="text-success">
                              <i class="ti ti-video-plus text-success me-2"></i>Incoming
                              Video Call
                            </p>
                          </div>
                          <div class="chat-user-time">
                ...
                <div class="messages">
                  <div class="chats">
                    ...
                    <div class="chat-content">
                      ...
                      <div class="chat-profile-name">
                        <h6>
                          Anthony Lewis<i class="ti ti-circle-filled fs-7 mx-2"></i><span class="chat-time">08:00
                            AM</span>
                        </h6>
                      </div>
                      <div class="chat-info">
                  ...
                  <div class="chats chats-right">
                    <div class="chat-content">
                      ...
                      <div class="chat-profile-name text-end">
                        <h6>
                          You<i class="ti ti-circle-filled fs-7 mx-2"></i><span class="chat-time">08:00 AM</span><span
                            class="msg-read success"><i class="ti ti-checks"></i></span>
                        </h6>
                      </div>
                    </div>
                    <div class="chat-avatar">
                  ...
                  <div class="chats">
                    ...
                    <div class="chat-content">
                      <div class="chat-info">
                        <div class="message-content">
                          Yes, we’ll be using a time-tracking tool to log hours. You’ll
                          need to ensure you’re available during your usual working hours
                          and keep your manager updated if anything changes.
                          <div class="emoj-group">
                            <ul>
                              <li class="emoj-action">
                                <a href="#"><i class="ti ti-mood-smile"></i></a>
                  ...
                  <div class="chats">
                    ...
                    <div class="chat-content">
                      <div class="chat-profile-name">
                        <h6>
                          Edward Lietz<i class="ti ti-circle-filled fs-7 mx-2"></i><span class="chat-time">02:39
...
export default {
  ...
  methods: {
    scrollHanle() { },
    submitForm() {
      this.$router.push("/applications/chat");
    },
  },
};
</script>
