          ...
          <div class="d-flex my-xl-auto right-content align-items-center flex-wrap row-gap-3">
            ...
            <div class="dropdown me-3">
              ...
              <ul class="dropdown-menu dropdown-menu-end p-3">
                <li>
                  <a href="#" class="dropdown-item rounded-1">Incoming</a>
                </li>
                <li>
                  <a href="#" class="dropdown-item rounded-1">Outgoing</a>
                </li>
                <li>
                  <a href="#" class="dropdown-item rounded-1">Missed Call</a>
                </li>
              </ul>
            </div>
            <div class="dropdown">
              ...
              <template #bodyCell="{ column, record }">
                ...
                <template v-if="column.key === 'action'">
                  <div class="action-icon d-inline-flex">
                    <a href="#" class="me-2" data-bs-toggle="modal" data-bs-target="#call_history"><i
                        class="ti ti-eye"></i></a>
