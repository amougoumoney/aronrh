        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
          <div class="me-2 mb-2">
            <div class="d-flex align-items-center border bg-white rounded p-1 me-2">
              <router-link to="/crm/contacts" class="btn btn-icon btn-sm me-1"><i
                  class="ti ti-list-tree"></i></router-link>
              <router-link to="/crm/contacts-grid" class="btn btn-icon btn-sm active bg-primary text-white"><i
          ...
          <div class="mb-2">
            <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#add_contact"
              class="btn btn-primary d-flex align-items-center"><i class="ti ti-circle-plus me-2"></i>Add Contact</a>
          </div>
                  ...
                  <ul class="dropdown-menu dropdown-menu-end p-3">
                    <li>
                      <a class="dropdown-item rounded-1" href="javascript:void(0);" data-bs-toggle="modal"
                        data-bs-target="#edit_contact"><i class="ti ti-edit me-1"></i>Edit</a>
                    </li>
                    <li>
                      <a class="dropdown-item rounded-1" href="javascript:void(0);" data-bs-toggle="modal"
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-center mb-3">
                <h6 class="mb-1">
                  <router-link to="/crm/contact-details">Dawn Mercha</router-link>
                </h6>
                <span class="badge bg-pink-transparent fs-10 fw-medium">UI /UX Designer</span>
              </div>
              <div class="d-flex flex-column">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-center mb-3">
                <h6 class="mb-1">
                  <router-link to="/crm/contact-details">Rachel Hampton</router-link>
                </h6>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-center mb-3">
                <h6 class="mb-1">
                  <router-link to="/crm/contact-details">Jonelle Curtiss</router-link>
                </h6>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-center mb-3">
                <h6 class="mb-1">
                  <router-link to="/crm/contact-details">Jonathan Smith</router-link>
                </h6>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-center mb-3">
                <h6 class="mb-1">
                  <router-link to="/crm/contact-details">Patricia Carter</router-link>
                </h6>
                <span class="badge bg-pink-transparent fs-10 fw-medium">Team Lead Dev</span>
              </div>
              <div class="d-flex flex-column">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-center mb-3">
                <h6 class="mb-1">
                  <router-link to="/crm/contact-details">Jeffrey Jarrett</router-link>
                </h6>
                <span class="badge bg-pink-transparent fs-10 fw-medium">Team Lead Dev</span>
              </div>
              <div class="d-flex flex-column">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-center mb-3">
                <h6 class="mb-1">
                  <router-link to="/crm/contact-details">Gloria Rubio</router-link>
                </h6>
                <span class="badge bg-pink-transparent fs-10 fw-medium">Team Lead Dev</span>
              </div>
              <div class="d-flex flex-column">
