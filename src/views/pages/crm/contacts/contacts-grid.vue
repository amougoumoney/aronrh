        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
          <div class="me-2 mb-2">
            <div class="d-flex align-items-center border bg-white rounded p-1 me-2">
              <router-link to="/crm/contacts" class="btn btn-icon btn-sm me-1"
          ...
          <div class="mb-2">
            <a
              ...
              ><i class="ti ti-circle-plus me-2"></i>Add Contact</a
            >
          </div>
          ...
          <div class="card">
            <div class="card-body">
              ...
              >
                ...
                <span class="d-inline-flex align-items-center"
                  ><i class="ti ti-star-filled text-warning me-1"></i>3.1</span
                >
              </div>
            </div>
          </div>
          ...
          <div class="card">
            <div class="card-body">
              ...
              >
                ...
                <span class="d-inline-flex align-items-center"
                  ><i class="ti ti-star-filled text-warning me-1"></i>4.1</span
                >
              </div>
            </div>
          </div>
