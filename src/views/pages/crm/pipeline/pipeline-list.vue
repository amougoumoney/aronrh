                ...
                <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                    ...
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap row-gap-3">
                        ...
                        <div class="dropdown me-3">
                            ...
                            <ul class="dropdown-menu  dropdown-menu-end p-3">
                                <li>
                                    <a href="#" class="dropdown-item rounded-1">Won</a>
                                </li>
                                <li>
                                    <a href="#" class="dropdown-item rounded-1">In Pipeline</a>
                                </li>
                                <li>
                                    <a href="#" class="dropdown-item rounded-1">Conversation</a>
                                </li>
                                <li>
                                    <a href="#" class="dropdown-item rounded-1">Follow Up</a>
                                </li>
                            </ul>
                        </div>
                        <div class="dropdown me-3">
                            ...
                            <ul class="dropdown-menu  dropdown-menu-end p-3">
                                <li>
                                    <a href="#" class="dropdown-item rounded-1">$10 - $20</a>
                                </li>
                                <li>
                                    <a href="#" class="dropdown-item rounded-1">$20 - $30</a>
                                </li>
                                <li>
                                    <a href="#" class="dropdown-item rounded-1">$40 - $50</a>
                                </li>
                            </ul>
                        </div>
                        <div class="dropdown me-3">
