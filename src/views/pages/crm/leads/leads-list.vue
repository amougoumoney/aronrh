        ...
        <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
          ...
          <div class="d-flex my-xl-auto right-content align-items-center flex-wrap row-gap-3">
            ...
            <div class="dropdown me-3">
              ...
              <ul class="dropdown-menu dropdown-menu-end p-3">
                <li>
                  <a href="#" class="dropdown-item rounded-1">Closed</a>
                </li>
                <li>
                  <a href="#" class="dropdown-item rounded-1">Contacted</a>
                </li>
                <li>
                  <a href="#" class="dropdown-item rounded-1">Lost</a>
                </li>
                <li>
                  <a href="#" class="dropdown-item rounded-1">Not Contacted</a>
                </li>
              </ul>
            </div>
            <div class="dropdown">
              ...
              <template #bodyCell="{ column, record }">
                ...
                <template v-if="column.key === 'action'">
                  <div class="action-icon d-inline-flex">
                    <a href="#" class="me-2" data-bs-toggle="modal" data-bs-target="#edit_leads"><i
