        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
          <div class="me-2 mb-2">
            <div class="d-flex align-items-center border bg-white rounded p-1 me-2">
              <router-link to="/crm/deals-list" class="btn btn-icon btn-sm me-1"><i
                  class="ti ti-list-tree"></i></router-link>
              <router-link to="/crm/deals-grid" class="btn btn-icon btn-sm active bg-primary text-white"><i
...
<script>
import dealsBoard from "./deals-board.vue";
export default {
  components: { dealsBoard },
  data() {
    return {
      title: "Deals",
      text: "CRM",
