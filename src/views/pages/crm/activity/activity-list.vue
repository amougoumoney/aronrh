        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
          ...
          <div class="mb-2">
            <a href="#" data-bs-toggle="modal" data-bs-target="#add_activity"
              class="btn btn-primary d-flex align-items-center"><i class="ti ti-circle-plus me-2"></i>Add Activity</a>
          </div>
        ...
        <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
          ...
          <div class="d-flex my-xl-auto right-content align-items-center flex-wrap row-gap-3">
            ...
            <div class="dropdown me-3">
              ...
              <ul class="dropdown-menu dropdown-menu-end p-3">
                <li>
                  <a href="#" class="dropdown-item rounded-1">Meeting</a>
                </li>
                <li>
                  <a href="#" class="dropdown-item rounded-1">Calls</a>
                </li>
                <li>
                  <a href="#" class="dropdown-item rounded-1">Tasks</a>
                </li>
                <li>
                  <a href="#" class="dropdown-item rounded-1">Email</a>
                </li>
              </ul>
            </div>
            <div class="dropdown">
