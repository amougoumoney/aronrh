                            ...
                            <div class="card flex-fill">
                                <div class="card-body ">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-4">
                                            <apexchart type="donut" height="200" :options="donutAreaChart.sline"
                                                :series="donutAreaChart.series"></apexchart>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card flex-fill">
                                <div class="card-body ">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-4">
                                            <apexchart type="donut" height="200" :options="donutAreaChartOne.sline"
                                                :series="donutAreaChartOne.series"></apexchart>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card flex-fill">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-4">
                                            <apexchart type="donut" height="200" :options="donutAreaChartTwo.sline"
                                                :series="donutAreaChartTwo.series"></apexchart>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card flex-fill">
                                <div class="card-body ">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-4">
                                            <apexchart type="donut" height="200" :options="donutAreaChartThree.sline"
                                                :series="donutAreaChartThree.series"></apexchart>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6 d-flex align-items-center justify-content-center">
                                    <div class="position-relative payment-total">
                                        <div id="task-reports">
                                            <apexchart type="donut" height="180" :options="taskReports.sline"
                                                :series="taskReports.series"></apexchart>
                                        </div>
                                    ...
                                    <div class="row gy-4">
                                        <div class="col-md-6">
                                            <div class="d-flex task-report-icons">
                                                <span class="me-2"><i
                                                        class="ti ti-arrow-badge-right-filled text-success"></i></span>
                                                <h6 class="fs-16">Completed <span class="fs-14 fw-normal">40%</span>
                                                </h6>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="d-flex task-report-icons">
                                                <span class="me-2"><i
                                                        class="ti ti-arrow-badge-right-filled text-skyblue"></i></span>
                                        ...
                                        <div class="col-md-6">
                                            <div class="d-flex task-report-icons">
                                                <span class="me-2"><i
                                                        class="ti ti-arrow-badge-right-filled text-warning"></i></span>
                                                <h6 class="fs-16">Inprogress <span class="fs-14 fw-normal">20 %</span>
                                                </h6>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="d-flex task-report-icons">
                                                <span class="me-2"><i
                                                        class="ti ti-arrow-badge-right-filled text-purple"></i></span>
