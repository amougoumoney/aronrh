                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="row align-items-center mb-3">
                        ...
                        <div class="col-md-8">
                          <div>
                            <vue-select :options="IndUk" id="induk" placeholder="Select" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="row align-items-center mb-3">
                        ...
                        <div class="col-md-8">
                          <div>
                            <vue-select :options="UkSek" id="ujsek" placeholder="Select" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="row align-items-center mb-3">
                        ...
                        <div class="col-md-8">
                          <vue-select :options="Cityselc" id="cityselc" placeholder="Select" />
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
...
export default {
  data() {
    return {
      ...
      IndUk: ["Select", "France", "Germany", "Canada", "USA"],
      Cityselc: ["Select", "Los Angeles", "San Diego", "Fresno", "San Francisco"],
      title: "Settings",
      text: "Administration",
      text1: "Settings",
    };
