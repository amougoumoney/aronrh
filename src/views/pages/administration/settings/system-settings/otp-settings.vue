                  ...
                  <div class="row">
                    <div class="col-md-8">
                      <div class="row align-items-center">
                        ...
                        <div class="col-lg-5">
                          <div class="mb-3">
                            <vue-select :options="OptSel" id="otpsel" placeholder="Select" />
                          </div>
                        </div>
                      </div>
                      <div class="row align-items-center">
                        ...
                        <div class="col-lg-5">
                          <div class="mb-3">
                            <vue-select :options="DightSele" id="gightSele" placeholder="Select" />
                          </div>
                        </div>
                      </div>
                      <div class="row align-items-center">
                        ...
                        <div class="col-lg-5">
                          <div class="mb-3">
                            <vue-select :options="ExpriTime" id="expritime" placeholder="Select" />
                          </div>
                        </div>
                      </div>
                    </div>
...
export default {
  data() {
    return {
      ...
      DightSele: ["Select", "4", "6"],
      ExpriTime: ["Select", "5 Mins", "10 Mins"],
      title: "Settings",
      text: "Administration",
      text1: "Settings",
    };
