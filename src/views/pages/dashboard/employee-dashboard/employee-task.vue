      ...
      <div class="card flex-fill">
        <div class="card-header">
          <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2">
            <h5>Projects</h5>
            <div class="dropdown">
              <a href="#" class="btn btn-white border-0 dropdown-toggle border btn-sm d-inline-flex align-items-center"
                data-bs-toggle="dropdown">
                Ongoing Projects
              </a>
              <ul class="dropdown-menu dropdown-menu-end p-3">
                <li>
                  <a href="#" class="dropdown-item rounded-1">All Projects</a>
                </li>
                <li>
                  <a href="#" class="dropdown-item rounded-1">Ongoing Projects</a>
                </li>
              </ul>
            </div>
          </div>
              ...
              <div class="card mb-4 shadow-none mb-md-0">
                <div class="card-body">
                  ...
                  <div>
                    ...
                    <div class="d-flex align-items-center mb-3">
                      <a href="#" class="avatar bg-soft-primary rounded-circle">
                    ...
                    <div class="bg-soft-secondary p-2 rounded d-flex align-items-center justify-content-between">
                      ...
                      <h5 class="text-secondary text-truncate">
                        65/120 <span class="fs-14 fw-normal">Hrs</span>
                      </h5>
                    </div>
                  </div>
                </div>
