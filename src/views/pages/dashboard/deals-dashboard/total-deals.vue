  ...
  <div class="row">
    <div class="col-xl-6 d-flex">
      <div class="row flex-fill">
        <div class="col-sm-6">
          <div
            class="card bg-linear-gradiant border-white border-2 overlay-bg-3 position-relative"
          >
            <div class="card-body">
              <div
              ...
              >
                ...
                <div class="avatar avatar-md br-10 icon-rotate bg-primary">
                  <span class="d-flex align-items-center"
                    ><i class="ti ti-delta text-white fs-16"></i
                  ></span>
                </div>
              </div>
              ...
              <p class="fw-medium fs-13">
                <span class="text-danger fs-12"
                  ><i class="ti ti-arrow-wave-right-up me-1"></i>-4.01%
                </span>
                from last week
              </p>
            </div>
            ...
            <div class="card-body">
              ...
              >
                ...
                <div class="avatar avatar-md br-10 icon-rotate bg-secondary">
                  <span class="d-flex align-items-center"
                    ><i class="ti ti-currency text-white fs-16"></i
                  ></span>
                </div>
              </div>
              <div class="progress progress-xs mb-2">
            ...
            <div class="card-body">
              ...
              >
                ...
                <div class="avatar avatar-md br-10 icon-rotate bg-pink">
                  <span class="d-flex align-items-center"
                    ><i class="ti ti-stairs-up text-white fs-16"></i
                  ></span>
                </div>
              </div>
              <div class="progress progress-xs mb-2">
              ...
              <p class="fw-medium fs-13">
                <span class="text-success fs-12"
                  ><i class="ti ti-arrow-wave-right-up me-1"></i>+55%
                </span>
                from last week
              </p>
            </div>
        ...
        <div class="col-sm-6">
            ...
            <div class="card-body">
              ...
              >
                ...
                <div class="avatar avatar-md br-10 icon-rotate bg-purple">
                  <span class="d-flex align-items-center"
                    ><i class="ti ti-users-group text-white fs-16"></i
                  ></span>
                </div>
              </div>
              <div class="progress progress-xs mb-2">
            ...
            <div class="card-body">
              ...
              >
                ...
                <div class="avatar avatar-md br-10 icon-rotate bg-info">
                  <span class="d-flex align-items-center"
                    ><i class="ti ti-swipe text-white fs-16"></i
                  ></span>
                </div>
              </div>
              <div class="progress progress-xs mb-2">
              ...
              <p class="fw-medium fs-13">
                <span class="text-danger fs-12"
                  ><i class="ti ti-arrow-wave-right-up me-1"></i>-6.01%
                </span>
                from last week
              </p>
            </div>
          ...
          >
            <div class="card-body">
              ...
              <p class="fw-medium fs-13">
                <span class="text-danger fs-12"
                  ><i class="ti ti-arrow-wave-right-up me-1"></i>-3.22%
                </span>
                from last week
              </p>
            </div>
        ...
        <div class="card-body">
          <div id="pipeline_chart">
            <apexchart
              type="bar"
              height="280"
              :options="pipelineCharts.pipeline"
              :series="pipelineCharts.series"
            >
            </apexchart>
          </div>
          <div>
            ...
            <div class="row g-2 justify-content-center">
              <div class="col-md col-sm-4 col-6">
                <div class="border rounded text-center p-2">
                  <p class="mb-1">
                    <i class="ti ti-point-filled text-primary"></i>Marketing
                  </p>
                  <h6>$5,221,45</h6>
                </div>
              </div>
              ...
              <div class="col-md col-sm-4 col-6">
                <div class="border rounded text-center p-2">
                  <p class="mb-1">
                    <i class="ti ti-point-filled text-primary"></i>Operational
                  </p>
                  <h6>$10,557</h6>
                </div>
              </div>
