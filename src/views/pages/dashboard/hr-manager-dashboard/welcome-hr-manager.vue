  ...
  <div class="card border-0">
    <div class="card-body d-flex align-items-center justify-content-between flex-wrap pb-1">
      ...
      <div class="d-flex align-items-center flex-wrap mb-1">
        <a href="javascript:void(0);" class="btn btn-secondary btn-md me-2 mb-2" data-bs-toggle="modal"
        ...
        <a href="javascript:void(0);" class="btn btn-primary btn-md mb-2" data-bs-toggle="modal"
          data-bs-target="#add_leaves"><i class="ti ti-square-rounded-plus me-1"></i>Add Requests</a>
      </div>
    </div>
  </div>
  <!-- /Welcome Wrap -->
