...
export default {
  ...
  methods: {
    ...
    toggleClickedEight() {
      this.isClickedEight = !this.isClickedEight;
    },
    toggleClickedNine() {
      this.isClickedNine = !this.isClickedNine;
    },
    toggleClickedTen() {
      this.isClickedTen = !this.isClickedTen;
    },
    toggleClickedEleven() {
      this.isClickedEleven = !this.isClickedEleven;
    },
    OnetoggleClicked() {
      this.OneisClicked = !this.OneisClicked;
    },
    TwotoggleClicked() {
      this.TwoisClicked = !this.TwoisClicked;
    },
    ThreetoggleClicked() {
      this.ThreeisClicked = !this.ThreeisClicked;
    },
    FourtoggleClicked() {
      this.FourisClicked = !this.FourisClicked;
    },
    FivetoggleClicked() {
      this.FiveisClicked = !this.FiveisClicked;
    },
    SixtoggleClicked() {
      this.SixisClicked = !this.SixisClicked;
    },
    seventoggleClicked() {
      this.sevenisClicked = !this.sevenisClicked;
    },
    EighttoggleClicked() {
      this.EightisClicked = !this.EightisClicked;
    },
    toggleHeader() {
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center pb-3 mb-3 border-bottom">
                  <router-link to="/projects/task-details" class="flex-shrink-0 me-2">
                    <img src="@/assets/img/social/project-01.svg" alt="Img" />
                  </router-link>
                  <div>
                    <h6 class="mb-1">
                      <router-link to="/projects/task-details">Hospital Administration</router-link>
                    </h6>
                  ...
                  <div class="col-sm-4">
                    <div class="mb-3">
                      ...
                      <h6 class="fw-normal d-flex align-items-center">
                        <img class="avatar avatar-xs rounded-circle me-1" src="@/assets/img/profiles/avatar-01.jpg"
                          alt="Img" />
                        Leona
                      </h6>
                    </div>
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center pb-3 mb-3 border-bottom">
                  ...
                  <div>
                    <h6 class="mb-1">
                      <router-link to="/projects/task-details">Educational Platform
                      </router-link>
                    </h6>
                    <div class="d-flex align-items-center">
                      <span>22 tasks</span>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <div class="mb-3">
                      <span class="mb-1 d-block">Project Lead</span>
                      <h6 class="fw-normal d-flex align-items-center">
                        <img class="avatar avatar-xs rounded-circle me-1" src="@/assets/img/profiles/avatar-06.jpg"
                          alt="Img" />
                        Harvey Smith
                      </h6>
                    </div>
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center pb-3 mb-3 border-bottom">
                  ...
                  <div>
                    <h6 class="mb-1">
                      <router-link to="/projects/task-details">Chat & Call Mobile App</router-link>
                    </h6>
                    <div class="d-flex align-items-center">
                      <span>20 tasks</span>
                      <span class="mx-1"><i class="ti ti-point-filled text-primary"></i></span>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <div class="mb-3">
                      <span class="mb-1 d-block">Project Lead</span>
                      <h6 class="fw-normal d-flex align-items-center">
                        <img class="avatar avatar-xs rounded-circle me-1" src="@/assets/img/profiles/avatar-27.jpg"
                          alt="Img" />
                        Stephan Peralt
                      </h6>
                    </div>
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center pb-3 mb-3 border-bottom">
                  ...
                  <div>
                    <h6 class="mb-1">
                      <router-link to="/projects/task-details">Travel Planning Website</router-link>
                    </h6>
                    <div class="d-flex align-items-center">
                      <span>18 tasks</span>
                      <span class="mx-1"><i class="ti ti-point-filled text-primary"></i></span>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <div class="mb-3">
                      <span class="mb-1 d-block">Project Lead</span>
                      <h6 class="fw-normal d-flex align-items-center">
                        <img class="avatar avatar-xs rounded-circle me-1" src="@/assets/img/profiles/avatar-23.jpg"
                          alt="Img" />
                        Doglas Martini
                      </h6>
                    </div>
                ...
                <div class="list-group-item list-item-hover shadow-sm rounded mb-2 p-3">
                  <div class="row align-items-center row-gap-3">
                    ...
                    <div class="col-md-5">
                      <div class="d-flex align-items-center justify-content-md-end flex-wrap row-gap-3">
                        <span class="badge badge-skyblue me-3">Web Design</span>
                        <span class="badge badge-purple-transparent d-flex align-items-center me-3"><i
                            class="fas fa-circle fs-6 me-1"></i>Inprogress</span>
                        <div class="d-flex align-items-center">
                          <div class="avatar-list-stacked avatar-group-sm">
                            <span class="avatar avatar-rounded">
              ...
              <div class="list-group list-group-flush mb-4">
                ...
                <div class="list-group-item list-item-hover shadow-sm rounded mb-2 p-3">
                  <div class="row align-items-center row-gap-3">
                    <div class="col-md-7">
                      <div class="todo-inbox-check d-flex align-items-center flex-wrap row-gap-3"
                        :class="{ 'todo-strike-content': OneisClicked }" @click="OnetoggleClicked">
                        <span class="me-2 d-flex align-items-center"><i class="ti ti-grid-dots text-dark"></i></span>
                        <div class="form-check form-check-md me-2">
                          <input class="form-check-input" type="checkbox" checked="" />
                        </div>
                ...
                <div class="list-group-item list-item-hover shadow-sm rounded mb-2 p-3">
                  <div class="row align-items-center row-gap-3">
                    <div class="col-md-7">
                      <div class="todo-inbox-check d-flex align-items-center flex-wrap row-gap-3"
                        :class="{ 'todo-strike-content': TwoisClicked }" @click="TwotoggleClicked">
                        <span class="me-2 d-flex align-items-center"><i class="ti ti-grid-dots text-dark"></i></span>
                        <div class="form-check form-check-md me-2">
                          <input class="form-check-input" type="checkbox" checked="" />
                        </div>
                ...
                <div class="list-group-item list-item-hover shadow-sm rounded p-3">
                  <div class="row align-items-center row-gap-3">
                    <div class="col-md-7">
                      <div class="todo-inbox-check d-flex align-items-center flex-wrap row-gap-3"
                        :class="{ 'todo-strike-content': ThreeisClicked }" @click="ThreetoggleClicked">
                        <span class="me-2 d-flex align-items-center"><i class="ti ti-grid-dots text-dark"></i></span>
                        <div class="form-check form-check-md me-2">
                          <input class="form-check-input" type="checkbox" checked="" />
                        </div>
              ...
              <div class="list-group list-group-flush mb-4">
                <div class="list-group-item list-item-hover shadow-sm rounded mb-2 p-3">
                  <div class="row align-items-center row-gap-3">
                    <div class="col-lg-6 col-md-7">
                      <div class="todo-inbox-check d-flex align-items-center flex-wrap row-gap-3"
                        :class="{ 'todo-strike-content': FourisClicked }" @click="FourtoggleClicked">
                        <span class="me-2 d-flex align-items-center"><i class="ti ti-grid-dots text-dark"></i></span>
                        <div class="form-check form-check-md me-2">
                          <input class="form-check-input" type="checkbox" />
                        </div>
                ...
                <div class="list-group-item list-item-hover shadow-sm rounded mb-2 p-3">
                  <div class="row align-items-center row-gap-3">
                    <div class="col-md-7">
                      <div class="todo-inbox-check d-flex align-items-center flex-wrap row-gap-3"
                        :class="{ 'todo-strike-content': FiveisClicked }" @click="FivetoggleClicked">
                        <span class="me-2 d-flex align-items-center"><i class="ti ti-grid-dots text-dark"></i></span>
                        <div class="form-check form-check-md me-2">
                          <input class="form-check-input" type="checkbox" />
                        </div>
                ...
                <div class="list-group-item list-item-hover shadow-sm rounded mb-2 p-3">
                  <div class="row align-items-center row-gap-3">
                    <div class="col-md-7">
                      <div class="todo-inbox-check d-flex align-items-center flex-wrap row-gap-3"
                        :class="{ 'todo-strike-content': SixisClicked }" @click="SixtoggleClicked">
                        <span class="me-2 d-flex align-items-center"><i class="ti ti-grid-dots text-dark"></i></span>
                        <div class="form-check form-check-md me-2">
                          <input class="form-check-input" type="checkbox" checked="" />
                        </div>
                ...
                <div class="list-group-item list-item-hover shadow-sm rounded mb-2 p-3">
                  <div class="row align-items-center row-gap-3">
                    <div class="col-md-7">
                      <div class="todo-inbox-check d-flex align-items-center flex-wrap row-gap-3"
                        :class="{ 'todo-strike-content': SevenisClicked }" @click="SeventoggleClicked">
                        <span class="me-2 d-flex align-items-center"><i class="ti ti-grid-dots text-dark"></i></span>
                        <div class="form-check form-check-md me-2">
                          <input class="form-check-input" type="checkbox" checked="" />
                        </div>
                ...
                <div class="list-group-item list-item-hover shadow-sm rounded p-3">
                  <div class="row align-items-center row-gap-3">
                    <div class="col-md-7">
                      <div class="todo-inbox-check d-flex align-items-center flex-wrap row-gap-3"
                        :class="{ 'todo-strike-content': EightisClicked }" @click="EighttoggleClicked">
                        <span class="me-2 d-flex align-items-center"><i class="ti ti-grid-dots text-dark"></i></span>
                        <div class="form-check form-check-md me-2">
                          <input class="form-check-input" type="checkbox" checked="" />
                        </div>
