          ...
          <div class="d-flex">
            <div class="text-end">
              <a
                ...
                ><i class="ti ti-edit me-1"></i>Edit Project</a
              >
            </div>
                ...
                <div class="list-group-item">
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <span
                        class="badge badge-danger d-inline-flex align-items-center ms-2"
                        ><i class="ti ti-clock-stop"></i>1</span
                      >
                    </div>
                  </div>
                </div>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-sm-9">
                  <span
                    ...
                    ><i class="ti ti-point-filled me-1"></i>InProgress</span
                  >
                </div>
                <div class="col-sm-3">
                  <p class="d-flex align-items-center mb-3">
                ...
                <div class="col-sm-9">
                  <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="bg-gray-100 p-1 rounded d-flex align-items-center me-2">
                      ...
                      <h6 class="fs-12"><a href="javascript:void(0);">Meredith</a></h6>
                    </div>
                    <div>
                      <a
                        href="javascript:void(0);"
                ...
                <div class="col-sm-9">
                  <div class="d-flex align-items-center mb-3">
                    <div class="bg-gray-100 p-1 rounded d-flex align-items-center me-2">
                      ...
                      <h6 class="fs-12"><a href="javascript:void(0);">Dwight</a></h6>
                    </div>
                    <div>
                      <a
                        href="javascript:void(0);"
                    ...
                    <div class="d-flex align-items-center flex-fill">
                      ...
                      <div class="ms-auto d-flex align-items-center">
                        <a
                          ...
                          ><i class="ti ti-square-rounded-plus-filled me-1"></i>Add New</a
                        >
                        <a
                          href="javascript:void(0);"
                          class="d-flex align-items-center collapsed collapse-arrow"
                            ...
                            <div class="card-body">
                              ...
                              >
                                <div class="d-flex align-items-center">
                                  <a
                                    href="javascript:void(0);"
                                    class="avatar avatar-md bg-light me-2"
                                  >
                                    <img
                              ...
                              >
                                ...
                                <span class="avatar avatar-sm avatar-rounded"
                                  ><img
                                    :src="require(`@/assets/img/users/${item.Image}`)"
                                    alt="Img"
                                /></span>
                              </div>
                            </div>
                        ...
                        <div class="d-flex align-items-center flex-fill">
                          ...
                          <div class="ms-auto d-flex align-items-center">
                            <a
                              href="javascript:void(0);"
                              class="btn btn-primary btn-xs d-inline-flex align-items-center me-3"
                              ><i class="ti ti-square-rounded-plus-filled me-1"></i>Add
                              New</a
                            >
                            <a
                              href="javascript:void(0);"
                    ...
                    <div class="list-group list-group-flush">
                      <div class="list-group-item border rounded mb-2 p-2">
                        <div class="row align-items-center g-3">
                          <div class="col-sm-6">
                            <div class="d-flex align-items-center">
                              <span class="avatar avatar-lg bg-light flex-shrink-0 me-2"
                                ><i class="ti ti-file-invoice text-dark fs-24"></i
                              ></span>
                              <div>
                          ...
                          <div class="col-sm-3">
                            <div class="d-flex align-items-center justify-content-sm-end">
                              <span
                                class="badge badge-soft-success d-inline-flex align-items-center me-4"
                        ...
                        <div class="row align-items-center g-3">
                          ...
                          <div class="col-sm-3">
                            <div class="d-flex align-items-center justify-content-sm-end">
                              <span
                                class="badge badge-soft-success d-inline-flex align-items-center me-4"
                                ><i class="ti ti-point-filled me-1"></i>Hold</span
                              >
                              <a href="javascript:void(0);" class="btn btn-icon btn-sm"
                                ><i class="ti ti-edit"></i
                              ></a>
                      ...
                      <div class="list-group-item border rounded p-2">
                        <div class="row align-items-center g-3">
                          ...
                          <div class="col-sm-3">
                            <div class="d-flex align-items-center justify-content-sm-end">
                              <span
                                class="badge badge-soft-danger d-inline-flex align-items-center me-4"
                                ><i class="ti ti-point-filled me-1"></i>unpaid</span
                              >
                              <a href="javascript:void(0);" class="btn btn-icon btn-sm"
                                ><i class="ti ti-edit"></i
                              ></a>
              ...
              <div class="dropdown">
                ...
                >
                  <li>
                    ...
                    >
                      <span class="avatar avatar-md bg-gray-800 flex-shrink-0 me-2"
                        ><i class="ti ti-basket-code"></i
                      ></span>
                      <div>
