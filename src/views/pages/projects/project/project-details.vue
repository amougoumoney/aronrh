        ...
        <div class="d-md-flex d-sm-block justify-content-between align-items-center flex-wrap">
          ...
          <div class="d-flex">
            ...
            <div class="head-icons ms-2 text-end">
              <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Collapse"
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="row align-items-center">
                ...
                <div class="col-sm-3">
                  <p class="d-flex align-items-center mb-3">
                    <i class="ti ti-users-group me-2"></i>Team
                  </p>
                </div>
                <div class="col-sm-9">
                  <div class="d-flex align-items-center mb-3">
                    ...
                    <div>
                      <a href="#" class="d-flex align-items-center fs-12"><i class="ti ti-circle-plus me-1"></i>Add
                        New</a>
                    </div>
                  </div>
                </div>
                <div class="col-sm-3">
                  <p class="d-flex align-items-center mb-3">
                    <i class="ti ti-user-shield me-2"></i>Team Lead
                  </p>
                </div>
                <div class="col-sm-9">
                  <div class="d-flex align-items-center mb-3">
                ...
                <div class="col-sm-3">
                  <p class="d-flex align-items-center mb-3">
                    <i class="ti ti-user-star me-2"></i>Project Manager
                  </p>
                </div>
                <div class="col-sm-9">
                  <div class="d-flex align-items-center mb-3">
                ...
                <div class="col-sm-3">
                  <p class="d-flex align-items-center mb-3">
                    <i class="ti ti-bookmark me-2"></i>Tags
                  </p>
                </div>
                <div class="col-sm-9">
                  <div class="d-flex align-items-center mb-3">
                ...
                <div class="col-sm-12">
                  <div class="mb-3">
                    ...
                    <p>
                      The Enhanced Patient Management System (EPMS) project aims to
                      modernize and streamline the patient management processes within. By
                      integrating advanced technologies and optimizing existing workflows,
                      the project seeks to improve patient care, enhance operational
              ...
              <div class="accordion-item">
                <div class="accordion-header" id="headingTwo">
                  <div class="accordion-button">
                    <h5>Tasks</h5>
                    <div class="ms-auto">
                      <a href="#" class="d-flex align-items-center collapsed collapse-arrow" data-bs-toggle="collapse"
                  ...
                  <div class="accordion-button">
                    <div class="d-flex align-items-center flex-fill">
                      ...
                      <div class="ms-auto d-flex align-items-center">
                        <a href="#" class="btn btn-primary btn-xs d-inline-flex align-items-center me-3"><i
                  ...
                  <div class="accordion-body">
                    <div class="files-carousel owl-carousel">
                      <Carousel :wrap-around="true" :settings="settings" :breakpoints="breakpoints">
                        <Slide v-for="item in ProjectDetailsCarousel" :key="item.id">
                            ...
                            <div class="card-body">
                              <div class="d-flex align-items-center justify-content-between mb-2 pb-2 border-bottom">
                                <div class="d-flex align-items-center">
                                  ...
                                  <div>
                                    <h6 class="mb-1">{{ item.File_type }}</h6>
                                    <span>{{ item.Size }}</span>
                                  </div>
                                </div>
                                <div class="d-flex align-items-center">
                        ...
                        <div class="card">
                          <div class="card-body">
                            ...
                            <h6 class="d-flex align-items-center mb-2">
                              <i class="ti ti-point-filled text-primary me-1"></i>Changes
                              &amp; design
                            </h6>
                            <p class="text-truncate line-clamb-3">
                              An office management app project streamlines administrative
                              tasks by integrating tools for scheduling, communication,
                              and task management, enhancing overall productivity and
                              efficiency.
                            </p>
                          </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center flex-fill">
                          ...
                          <div class="ms-auto d-flex align-items-center">
                            <a href="#" class="btn btn-primary btn-xs d-inline-flex align-items-center me-3"><i
                              ...
                              New</a>
                            <a href="#" class="d-flex align-items-center collapsed collapse-arrow"
                              data-bs-toggle="collapse" data-bs-target="#primaryBorderSix" aria-expanded="false"
                        ...
                        <div class="notice-widget">
                            ...
                            <div class="d-flex overflow-hidden">
                              ...
                              <div class="overflow-hidden">
                                <p class="text-truncate mb-1">
                                  <span class="text-gray-9 fw-medium">Andrew </span>added
                                  a New Task
                                </p>
                          ...
                          <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="d-flex overflow-hidden me-2">
                              ...
                              <div class="overflow-hidden">
                                <p class="text-truncate mb-1">
                                  <span class="text-gray-9 fw-medium">Jermai </span>Moved
                                  task
                          ...
                          <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex overflow-hidden">
                              ...
                              <div class="overflow-hidden">
                                <p class="text-truncate mb-1">
                                  <span class="text-gray-9 fw-medium">Hendry </span>
                                  Updated Image
                                  <span class="text-gray-9 fw-medium"> “logo.jpg” </span>
                                </p>
                                <p class="mb-1">15 May 2024, 6:53 PM</p>
                                <div class="todo-inbox-check d-flex align-items-center">
                                  <div class="form-check form-check-md me-2">
              ...
              <div class="accordion-item">
                <div class="accordion-header" id="headingSeven">
                  <div class="accordion-button">
                    ...
                    <div class="ms-auto d-flex align-items-center">
                      <a href="#" class="d-flex align-items-center collapsed collapse-arrow" data-bs-toggle="collapse"
                        data-bs-target="#primaryBorderSeven" aria-expanded="false" aria-controls="primaryBorderSeven">
                        <i class="ti ti-chevron-down fs-18"></i>
                      </a>
                    </div>
                  </div>
...
import ProjectDetailsCarousel from "@/assets/json/project-details-carousel.json";
...
export default {
  data() {
    return {
      ...
      isClickedThree: true,
      isClickedFour: false,
      ProjectDetailsCarousel: ProjectDetailsCarousel,
      settings: {
        itemsToShow: 1,
        snapAlign: "center",
        loop: true,
