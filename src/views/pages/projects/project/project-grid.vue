<template>
        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
          <div class="me-2 mb-2">
            <div class="d-flex align-items-center border bg-white rounded p-1 me-2">
              <router-link to="/projects/projects-list" class="btn btn-icon btn-sm me-1"
                ><i class="ti ti-list-tree"></i
              ></router-link>
              <router-link
                to="/projects/projects-grid"
          ...
          <div class="mb-2">
            <a
              ...
              ><i class="ti ti-circle-plus me-2"></i>Add Project</a
            >
          </div>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="mb-3 pb-3 border-bottom">
                <p class="text-truncate line-clamb-3 mb-0">
              ...
              <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                  <span
                    class="avatar avatar-sm avatar-rounded bg-success-transparent flex-shrink-0 me-2"
                  >
        ...
        <div class="col-xxl-3 col-lg-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <div class="mb-3 pb-3 border-bottom">
                <p class="text-truncate line-clamb-3 mb-0">
                  Service booking software enables users to schedule appointments, manage
                  bookings, and handle payments for various services.
                </p>
              </div>
              <div
                class="d-flex align-items-center justify-content-between mb-3 pb-3 border-bottom"
          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex align-items-center justify-content-between mb-2">
                <h6>
                  <router-link to="/projects/projects-details"
                    >Car & Bike Rental Software</router-link
                  >
                </h6>
                <div class="dropdown">
                  <a
          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex align-items-center justify-content-between mb-2">
                <h6>
                  <router-link to="/projects/projects-details"
                    >Navigation and Safety App</router-link
                  >
                </h6>
                <div class="dropdown">
                  <a
              ...
              <div class="mb-3 pb-3 border-bottom">
                <p class="text-truncate line-clamb-3 mb-0">
                  ...
                  efficiently.A navigation and safety app provides real-time GPS guidance,
                  traffic updates, and route optimization to help users reach their
          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex align-items-center justify-content-between mb-2">
                <h6>
                  <router-link to="/projects/projects-details"
                    >POS Admin Software</router-link
                  >
                </h6>
                <div class="dropdown">
                  <a
              ...
              <div class="mb-3 pb-3 border-bottom">
                <p class="text-truncate line-clamb-3 mb-0">
                  POS admin software enables businesses to manage sales, track inventory,
                  and process transactions efficiently through a centralized platform.
                </p>
              </div>
              <div
                class="d-flex align-items-center justify-content-between mb-3 pb-3 border-bottom"
          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex align-items-center justify-content-between mb-2">
                <h6>
                  <router-link to="/projects/projects-details"
                    >Invoicing & Billing Software</router-link
                  >
                </h6>
                <div class="dropdown">
                  <a
  ...
  <!-- /Page Wrapper -->
  <project-grid-modal></project-grid-modal>
</template>
<script>
export default {
  data() {
