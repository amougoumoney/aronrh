        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
          <div class="me-2 mb-2">
            <div class="d-flex align-items-center border bg-white rounded p-1 me-2">
              <router-link to="/projects/clients" class="btn btn-icon btn-sm me-1"
          ...
          <div class="mb-2">
            <a
              ...
              ><i class="ti ti-circle-plus me-2"></i>Add Client</a
            >
          </div>
            ...
            <div class="card-body">
              ...
              >
                ...
                <div class="icons-social d-flex align-items-center">
                  <a
                    href="javascript:void(0);"
                    class="avatar avatar-rounded avatar-sm bg-light me-2"
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-center mb-3">
                <h6 class="mb-1">
                  <router-link to="/projects/clients-details"
                    >Kathleen Gutierrez</router-link
                  >
                </h6>
                <span class="badge bg-pink-transparent fs-10 fw-medium">Director</span>
              </div>
