<template>
        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
          <div class="me-2 mb-2">
            <div class="d-flex align-items-center border bg-white rounded p-1 me-2">
              <router-link to="/projects/clients" class="btn btn-icon btn-sm me-1"><i
                  class="ti ti-list-tree"></i></router-link>
              <router-link to="/projects/clients-grid" class="btn btn-icon btn-sm active bg-primary text-white"><i
          ...
          <div class="mb-2">
            <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#add_client"
              class="btn btn-primary d-flex align-items-center"><i class="ti ti-circle-plus me-2"></i>Add Client</a>
          </div>
          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-start mb-2">
                ...
                <div>
                  <router-link to="/projects/clients-details"
              ...
              <div class="text-center mb-3">
                <h6 class="mb-1">
                  <router-link to="/projects/clients-details">Michael Walker</router-link>
                </h6>
              ...
              <div class="d-flex align-items-center justify-content-between border-top pt-3 mt-3">
                ...
                <div class="icons-social d-flex align-items-center">
                  <a href="javascript:void(0);" class="avatar avatar-rounded avatar-sm bg-light me-2"><i
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-center mb-3">
                <h6 class="mb-1">
                  <router-link to="/projects/clients-details">Sophie Headrick</router-link>
                </h6>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-center mb-3">
                <h6 class="mb-1">
                  <router-link to="/projects/clients-details">Cameron Drake</router-link>
                </h6>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-center mb-3">
                <h6 class="mb-1">
                  <router-link to="/projects/clients-details">Doris Crowley</router-link>
                </h6>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-center mb-3">
                <h6 class="mb-1">
                  <router-link to="/projects/clients-details">Thomas Bordelon</router-link>
                </h6>
                <span class="badge bg-pink-transparent fs-10 fw-medium">Manager</span>
              </div>
              <div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-center mb-3">
                <h6 class="mb-1">
                  <router-link to="/projects/clients-details">Kathleen Gutierrez</router-link>
                </h6>
                <span class="badge bg-pink-transparent fs-10 fw-medium">Director</span>
              </div>
              <div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-center mb-3">
                <h6 class="mb-1">
                  <router-link to="/projects/clients-details">Bruce Wright</router-link>
                </h6>
                <span class="badge bg-pink-transparent fs-10 fw-medium">CEO</span>
              </div>
              <div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-center mb-3">
                <h6 class="mb-1">
                  <router-link to="/projects/clients-details">Estelle Morgan</router-link>
                </h6>
                <span class="badge bg-pink-transparent fs-10 fw-medium">Manager</span>
              </div>
              <div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-center mb-3">
                <h6 class="mb-1">
                  <router-link to="/projects/clients-details">Stephen Dias</router-link>
                </h6>
                <span class="badge bg-pink-transparent fs-10 fw-medium">CEO</span>
              </div>
              <div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-center mb-3">
                <h6 class="mb-1">
                  <router-link to="/projects/clients-details">Angela Thomas</router-link>
                </h6>
                <span class="badge bg-pink-transparent fs-10 fw-medium">Consultant</span>
              </div>
              <div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-center mb-3">
                <h6 class="mb-1">
                  <router-link to="/projects/clients-details">Charles Ramos</router-link>
                </h6>
                <span class="badge bg-pink-transparent fs-10 fw-medium">CEO</span>
              </div>
              <div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-center mb-3">
                <h6 class="mb-1">
                  <router-link to="/projects/clients-details">Shirley Begaye</router-link>
                </h6>
                <span class="badge bg-pink-transparent fs-10 fw-medium">Manager</span>
              </div>
              <div>
  ...
  <!-- /Page Wrapper -->
  <clients-list-modal></clients-list-modal>
</template>
<script>
export default {
  data() {
