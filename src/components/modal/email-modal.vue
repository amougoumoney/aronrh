            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <vue-select :options="EditemailMod" id="editemailmod" placeholder="Active" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="modal-content">
        <div class="modal-body text-center">
          ...
          <div class="d-flex justify-content-center">
            ...
            <router-link to="/system-settings/email-template" class="btn btn-danger">Yes, Delete</router-link>
          </div>
        </div>
      </div>
    </div>
...
export default {
  data() {
    return {
      ...
      editorData: " ",
      editorConfig: {},
      emailMod: ["Active", "Inactive"],
      EditemailMod: ["Active", "Inactive"],
    };
  },
  methods: {
    submitForm() {
