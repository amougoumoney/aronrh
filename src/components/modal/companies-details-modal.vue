            ...
            <div class="row">
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <vue-select :options="WrongNumb" id="wrongnumb" placeholder="Busy" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="mb-3">
                      ...
                      <vue-select :options="Wisozk" id="wiso" placeholder="Select" />
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-3">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <vue-select :options="Jackson" id="jackson" placeholder="Select" />
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-3">
                  ...
                  <div class="col-md-6">
                    <div class="input-block mb-3">
                      ...
                      <vue-select :options="Enes" id="ense" placeholder="Select" />
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-3">
                  ...
                  <div class="col-lg-12">
                    ...
                    <div class="border border-success bg-success-transparent p-3 rounded">
                      <p class="d-flex align-items-center">
                        <i class="ti ti-circle-check fs-24 me-2"></i> Document Sent
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <vue-select :options="Imap" id="imap" placeholder="select" />
                </div>
              </div>
              <div class="col-md-12">
                <div>
      ...
      <div class="modal-content">
        <div class="modal-body">
          <div class="text-center p-3">
            ...
            <router-link to="/applications/email" class="btn btn-primary w-100">Go to Email</router-link>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <vue-select :options="Collins" id="collins" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="input-block mb-3">
                  ...
                  <vue-select :options="Selectsal" id="selectsal" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                  <label class="form-label">Status <span class="text-danger"> *</span></label>
                  <vue-select :options="OpenSelec" id="openselec" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
                  <label class="form-label">Deal Value <span class="text-danger"> *</span></label>
                  <vue-select :options="Amountsel" id="amountsel" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
                  <label class="form-label">Currency<span class="text-danger"> *</span></label>
                  <vue-select :options="SeleCurent" id="selecurent" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
              ...
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <vue-select :options="Darleesh" id="darleesh" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Project * <span class="text-danger"> *</span></label>
                  <vue-select :options="Office" id="officeman" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
              ...
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <vue-select :options="CompaniesStat" id="compasel" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                  <label class="form-label">Tags <span class="text-danger"> *</span></label>
                  <vue-select :options="PromotionSel" id="promotionsel" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <vue-select :options="BarrySel" id="barrysel" plaecholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                  <label class="form-label">Priority <span class="text-danger"> *</span></label>
                  <vue-select :options="HighSel" id="higtsel" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-12">
                <div class="mb-3">
...
export default {
  data() {
    return {
      ...
      Collins: ["Select", "Collins", "Konopelsski", "Admas"],
      SeleCurent: ["Select", "$4,50,000", "$3,15,000", "$8,40,000"],
      Amountsel: ["$4,50,000", "$3,15,000", "$8,40,000"],
      OpenSelec: ["Select", "Open", "Won", "Lost"],
      Selectsal: ["Select", "Sales", "Marketing", "Calls"],
      Darleesh: ["Select", "Darlee Robertson", "Sharon Roy", "Vaughan Lewis"],
      Office: [
        "Select",
      ...
      CompaniesStat: ["Select", "Active", "Inactive"],
      PromotionSel: ["Select", "Promotion", "Collab", "Rated"],
      BarrySel: ["Select", "Barry Cuda", "Tressa Wexler"],
      HighSel: ["Select", "High", "Low", "Medium"],
      AdvanSelc: ["Select", "Advanced", "Basic", "Enterprise"],
      SelMonth: ["Select", "Monthly", "Yearly"],
      DollarSel: ["Select", "Dollar", "Euro"],
      EnglishSele: ["Select", "English", "Chinese"],
      InActiveSele: ["Select", "Active", "Inactive"],
      EditAdvanSelc: ["Select", "Advanced", "Basic", "Enterprise"],
      EditSelMonth: ["Select", "Monthly", "Yearly"],
      EditDollarSel: ["Select", "Dollar", "Euro"],
      EditEnglishSele: ["Select", "English", "Chinese"],
      EditInActiveSele: ["Select", "Active", "Inactive"],
      WrongNumb: ["Busy", "Unavailable", "No Answer", "Wrong Number"],
      Enes: ["Select", "en", "es", "ru"],
      Jackson: ["Select", "Admin", "Jackson Daniel"],
      Quote: ["Select", "Contract", "Proposal", "Quote"],
      Wisozk: ["Select", "Collins", "Wisozk", "Walter"],
      Imap: ["Select", "Gamil", "Outlook", "Imap"],
    };
  },
  methods: {
    toggleShow() {
    ...
    submitForm() {
      this.$router.push("/super-admin/companies");
    },
    submitFormOne() {
      this.$router.push("/crm/companies-details");
    },
    submitFormTwo() {
