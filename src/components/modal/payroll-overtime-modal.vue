          ...
          <div class="modal-body pb-0">
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Rate Type</label>
                  <vue-select :options="EditTyperat" id="edittyperat" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-12">
                <div class="mb-3">
      ...
      <div class="modal-content">
        <div class="modal-body text-center">
          ...
          <div class="d-flex justify-content-center">
            ...
            <router-link to="/payroll/payroll-overtime" class="btn btn-danger">Yes, Delete</router-link>
          </div>
        </div>
      </div>
    </div>
...
export default {
  data() {
    return {
      ...
      EditTyperat: ["Select", "Hourly 1.5", "Hourly 3", "Hourly 2"],
    };
  },
  methods: {
    submitForm() {
      this.$router.push("/payroll/payroll-overtime");
    },
  },
};
</script>
