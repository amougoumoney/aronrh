            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <vue-select :options="Headrick" id="headrick" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Status</label>
                  <vue-select :options="StaInactive" id="stainactive" placeholder="Select" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="modal-body pb-0">
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Asset User</label>
                  <vue-select :options="EditHeadrick" id="editheadrick" placeholder="Anthony Lewis" />
                </div>
              </div>
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Status</label>
                  <vue-select :options="EditStaInactive" id="editstainactive" placeholder="Active" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="modal-content">
        <div class="modal-body text-center">
          ...
          <div class="d-flex justify-content-center">
            ...
            <router-link to="/asset/assets" class="btn btn-danger">Yes, Delete</router-link>
          </div>
        </div>
      </div>
    </div>
...
export default {
  data() {
    return {
      ...
      StaInactive: ["Select", "Active", "Inactive"],
      Headrick: ["Select", "Anthony Lewis", "Brian Villalobos", "Sophie Headrick"],
      EditStaInactive: ["Select", "Active", "Inactive"],
      EditHeadrick: ["Select", "Anthony Lewis", "Brian Villalobos", "Sophie Headrick"],
    };
  },
  methods: {
    submitForm() {
      this.$router.push("/asset/assets");
    },
  },
};
</script>
