...
export default {
  data() {
    return {
      ...
      Jobtype: ["Select", "Full Time", "Part Time"],
      Joblevel: ["Select", "Team Lead", "Manager", "Senior", "junior"],
      Experience: ["Select", "Entry Level", "Mid Level", "Expert"],
      Qualification: ["Select", "Bachelore Degree", "Master Degree", "Others"],
      Gender: ["Select", "Male", "Female"],
      Minsalary: ["Select", "10k - 15k", "15k -20k"],
      Maxsalary: ["Select", "40k - 50k", "50k - 60k"],
      City: ["Select", "Los Angeles", "San Diego", "Fresno", "San Francisco"],
  ...
  methods: {
    submitForm() {
      this.$router.push("/recuritment/job-grid");
    },
  },
};
</script>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="mb-3">
                        ...
                        <vue-select :options="Jobcategory" id="ios" placeholder="Select" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                    ...
                    <div class="col-md-6">
                      <div class="mb-3">
                        ...
                        <vue-select :options="Joblevel" id="junior" placeholder="Select" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label">Experience <span class="text-danger"> *</span></label>
                        <vue-select :options="Experience" id="mid-level" placeholder="Select" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label">Qualification <span class="text-danger"> *</span></label>
                        <vue-select :options="Qualification" id="master-degree" placeholder="Select" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                    ...
                    <div class="col-md-6">
                      <div class="mb-3">
                        ...
                        <vue-select :options="Minsalary" id="female-min" placeholder="Select" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label">Max. Sallary <span class="text-danger"> *</span></label>
                        <vue-select :options="Maxsalary" id="female-salary" placeholder="Select" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="mb-3">
                        ...
                        <vue-select :options="City" id="female-city" placeholder="Select" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label">State <span class="text-danger"> *</span></label>
                        <vue-select :options="State" id="female-state" placeholder="Select" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label">Country <span class="text-danger"> *</span></label>
                        <vue-select :options="Country" id="female-country" placeholder="Select" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
