...
export default {
  data() {
    return {
      ...
      Promotionto: ["Select", "Sr Accountant", "Sr App Developer", "Sr SEO Analyst"],
      PromotiontoOne: ["Select", "Jr Accountant", "Jr App Developer", "Jr SEO Analyst"],
  ...
  methods: {
    submitForm() {
      this.$router.push("/hrm/promotion");
    },
  },
};
</script>
