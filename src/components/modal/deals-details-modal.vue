          ...
          <div class="modal-body pb-0">
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  <label class="form-label">Plan Name <span class="text-danger"> *</span></label>
                  <vue-select :options="EditEnterpro" id="editenterpro" placeholder="Advanced" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                  <label class="form-label">Plan Type <span class="text-danger"> *</span></label>
                  <vue-select :options="EditYearkyMin" id="edityearkymin" placeholder="Monthly" />
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
                  <label class="form-label">Currency <span class="text-danger"> *</span></label>
                  <vue-select :options="EditCurrUds" id="editcurruds" placeholder="Dollar" />
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
                  <label class="form-label">Language <span class="text-danger"> *</span></label>
                  <vue-select :options="EditChineEng" id="editchineeen" placeholder="English" />
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
                  <label class="form-label">Status</label>
                  <vue-select :options="EditActDeta" id="editactdeta" placeholder="Active" />
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <vue-select :options="ProposalCon" id="proposalcom" placeholder="Select" />
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-3">
      ...
      <div class="modal-content">
        <div class="modal-body">
          <div class="text-center p-3">
            ...
            <router-link to="/crm/deals-details" class="btn btn-primary w-100">Go to Email</router-link>
          </div>
        </div>
      </div>
    </div>
...
export default {
  data() {
    return {
      showPassword: false,
      showPassword1: false,
      Gamil: ["Select", "Gamil", "Outlook", "Imap"],
      EngSel: ["Select", "en", "es", "ru"],
      JackSoD: ["Select", "Admin", "Jackson Daniel"],
      ProposalCon: ["Select", "Contract", "Proposal", "Quote"],
      ChoDeal: ["Select", "Collins", "Wisozk", "Wlater"],
      Noans: ["Busy", "Unavailable", "No Answer", "Wrong Answer"],
      ActDeta: ["Select", "Active", "Inactive"],
      ChineEng: ["Select", "English", "CHinese"],
      CurrUds: ["Select", "USD", "Euro"],
      YearkyMin: ["Select", "Monthly", "Yearly"],
      Enterpro: ["Select", "Advanced", "Basic", "Enterprise"],
      EditActDeta: ["Select", "Active", "Inactive"],
      EditChineEng: ["Select", "English", "CHinese"],
      EditCurrUds: ["Select", "USD", "Euro"],
      EditYearkyMin: ["Select", "Monthly", "Yearly"],
      EditEnterpro: ["Select", "Advanced", "Basic", "Enterprise"],
    };
  },
  computed: {
    buttonLabel() {
