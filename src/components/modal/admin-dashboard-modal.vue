                  ...
                  <div class="col-md-12">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="mb-3">
                          <label class="form-label">Priority</label>
                          <vue-select :options="ProAdminOne" id="proadminone" placeholder="Select" />
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="mb-3">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <vue-select :options="SmithAdmin" id="smithadmin" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Leave Type</label>
                  <vue-select :options="LeaveAdmin" id="leaveadmin" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
...
export default {
  ...
  data() {
    return {
      ...
      LeaveAdmin: ["Select", "Medical Leave", "Casual Leave", "Annual Leave"],
      SmithAdmin: ["Select", "Anthony Lewis", "Brian Villalobos", "Harvey Smith"],
      MeduTag: ["Select", "High", "Low", "Medium"],
      StaisTag: ["Select", "Active", "Inactive"],
      BrAdmin: ["Select", "Anthony Lewis", "Brian Villalobos"],
      StatAdmin: ["Select", "Completed", "Pending", "Onhold", "Inprogress"],
      RufAdmin: ["Select", "Sophie", "Cameron", "Doris", "Rufana"],
      ProAdmin: ["Select", "Medium", "High", "Low"],
      ProAdminOne: ["Select", "Medium", "High", "Low"],
      Admtag: ["Select", "Internal", "Projects", "Meetings", "Reminder"],
