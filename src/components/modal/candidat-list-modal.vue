<template>
    <!-- Add Employee -->
    <div class="modal fade" v-show="showModal = true">
      <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content"> 
          <div class="modal-header">
            ...
            <button type="button" class="btn-close custom-btn-close" data-bs-dismiss="modal" @click="showModal = false"  aria-label="Close">
              <i class="ti ti-x"></i>
            </button>
          </div>
 ...
 const Desig = ["Select", "Finance", "Developer", "Executive"];
 const DepartM = ["Select", "All Department", "Finance", "Executive"];
 const EditDesig = ["Select", "Finance", "Developer", "Executive"];
 const EditDepartM = ["Select", "All Department", "Finance", "Executive"];
