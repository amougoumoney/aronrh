...
export default {
  data() {
    return {
      Paymentmethod: ["Select", "Sr Accountant", "Sr App Developer", "Sr SEO Analyst"],
  ...
  methods: {
    submitForm() {
      this.$router.push("/sales/expenses");
    },
  },
};
</script>
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <vue-select :options="Paymentmethod" id="payment-method" placeholder="Select" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Date</label>
                  <div class="input-icon-end position-relative">
                    <date-picker v-model="startdate" class="form-control datetimepicker" value="14/04/2024"
              ...
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Payment Method</label>
                  <vue-select :options="Paymentmethod" id="payment-method-one" placeholder="Sr accountant" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="modal-content">
        <div class="modal-body text-center">
          ...
          <div class="d-flex justify-content-center">
            ...
            <router-link to="/sales/expenses" class="btn btn-danger">Yes, Delete</router-link>
          </div>
        </div>
      </div>
    </div>
