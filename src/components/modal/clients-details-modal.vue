...
export default {
  data() {
    return {
      ...
      MediumSelec: ["Select", "High", "Medium", "Low"],
      Compend: ["Select", "Completed", "Pending", "Onhold", "Inprogress"],
      InternalSel: ["Select", "Internal", "Projects", "Meetings", "Reminder"],
    };
  },
  computed: {
    buttonLabel() {
  ...
  methods: {
    ...
    submitForm() {
      this.$router.push("/projects/clients-details");
    },
    submitFormOne() {
