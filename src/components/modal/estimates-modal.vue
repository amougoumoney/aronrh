...
export default {
  data() {
    return {
      Client: ["Select", "Michael Walker", "Sophie Headrick", "Cameron Drake"],
      Project: ["Select", "Project Management", "Office Management"],
      Tax: ["Select", "VAT", "GST", "No Tax"],
  ...
  methods: {
    submitForm() {
      this.$router.push("/sales/estimates");
    },
  },
};
</script>
