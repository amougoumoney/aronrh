          ...
          <div class="modal-body pb-0">
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="mb-3">
                  <label class="form-label">Status</label>
                  <vue-select :options="EditCurrenSta" id="editcurrensta" placeholder="Active" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="modal-content">
        <div class="modal-body text-center">
          ...
          <div class="d-flex justify-content-center">
            ...
            <router-link to="/financial-settings/currencies" class="btn btn-danger">Yes, Delete</router-link>
          </div>
        </div>
      </div>
    </div>
...
export default {
  data() {
    return {
      ...
      EditCurrenSta: ["Select", "Active", "Inactive"],
    };
  },
  methods: {
    submitForm() {
      this.$router.push("/financial-settings/currencies");
    },
  },
};
</script>
