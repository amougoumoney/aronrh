            ...
            <div class="row">
              ...
              <div class="col-6">
                <div class="mb-3">
                  ...
                  <vue-select :options="ProHighme" id="gjsej" placeholder="Select" />
                </div>
              </div>
              <div class="col-lg-12">
                <div class="mb-3">
              ...
              <div class="col-12">
                <div class="mb-3">
                  ...
                  <vue-select :options="AssDesig" id="assdeig" placeholder="Select" />
                </div>
              </div>
              <div class="col-12">
                <div class="mb-0">
...
export default {
  data() {
    return {
      ...
      editorData: " ",
      editorConfig: {},
      InterNalTa: ["Select", "Internal", "Projects", "Meetings", "Reminder"],
      ProHighme: ["Select", "Medium", "High", "Low"],
      AssDesig: ["Select", "Sophie", "Cameron", "Doris", "Rufana"],
      CompletPend: ["Select", "Completed", "Pending", "Onhold", "Inprogress"],
      EditInterNalTa: ["Select", "Internal", "Projects", "Meetings", "Reminder"],
      EditProHighme: ["Select", "Medium", "High", "Low"],
      EditAssDesig: ["Select", "Sophie", "Cameron", "Doris", "Rufana"],
      EditCompletPend: ["Select", "Completed", "Pending", "Onhold", "Inprogress"],
    };
  },
  methods: {
    submitForm() {
      this.$router.push("/applications/todo");
    },
  },
};
</script>
