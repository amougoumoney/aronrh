...
export default {
  data() {
    return {
      ...
      Statusone: ["Busy", "Unavailable", "No Answer", "Wrong Number"],
      Choosedeal: ["Select", "Collins", "Wisozk", "Walter"],
      Documenttype: ["Select", "Contract", "Proposal", "Quote"],
      ...
      Tags: ["Select", "Promotion", "Collab", "Rated"],
