...
export default {
  data() {
    return {
      ...
      SmithSel: ["Select", "Anthony Lewis", "Brian Villalobos", "Harvey Smith"],
      AnuMeLe: ["Select", "Medical Leave", "Casual Leave", "Annual Leave"],
      EditSmithSel: ["Select", "Anthony Lewis", "Brian Villalobos", "Harvey Smith"],
      EditAnuMeLe: ["Select", "Medical Leave", "Casual Leave", "Annual Leave"],
    };
  },
  methods: {
    submitForm() {
      this.$router.push("/app-settings/leave-type");
    },
  },
};
</script>
