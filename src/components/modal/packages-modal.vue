...
export default {
  data() {
    return {
      ...
      PlanPosition: ["Select", "1", "2", "3"],
      PlanCurrency: ["Select", "USD", "EURO"],
      PlanFree: ["Select", "Fixed", "Percentage"],
      DiscountType: ["Select", "Fixed", "Percentage"],
      PackStatus: ["Select", "Active", "Inactive"],
    };
  },
  methods: {
    submitForm() {
      this.$router.push("/super-admin/packages");
    },
  },
};
</script>
