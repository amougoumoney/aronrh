            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="input-block mb-3">
                  <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="#" class="add-new text-primary" data-bs-target="#add_pipeline" data-bs-toggle="modal"><i
              ...
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <vue-select :options="AssiInactive" id="inactAss" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
          ...
          <div class="modal-body pb-0">
            <div class="row">
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Deal Name <span class="text-danger"> *</span></label>
                  <vue-select :options="EditKonospk" id="editkonosk" placeholder="Collins" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="input-block mb-3">
                  ...
                  <vue-select :options="EditMarketing" id="editmarketin" placeholder="Sales" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  <label class="form-label">Currency<span class="text-danger"> *</span></label>
                  <vue-select :options="EditUSDEuro" id="editusdeuro" placeholder="Dollar" />
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
              ...
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Contact <span class="text-danger"> *</span></label>
                  <vue-select :options="EditRoyLeis" id="editroyleis" placeholder="Darlee Robertson" />
                </div>
              </div>
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Project * <span class="text-danger"> *</span></label>
                  <vue-select :options="EditoffApp" id="editoffapp" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
              ...
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Assignee <span class="text-danger"> *</span></label>
                  <vue-select :options="EditAssiInactive" id="editinactAss" placeholder="Active" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  <label class="form-label">Source <span class="text-danger"> *</span></label>
                  <vue-select :options="EditMediaGoo" id="editmedigoo" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                  <label class="form-label">Priority <span class="text-danger"> *</span></label>
                  <vue-select :options="EditHigloMed" id="edithighlomed" placeholder="High" />
                </div>
              </div>
              <div class="col-md-12">
                <div class="mb-3">
      ...
      <div class="modal-content">
        <div class="modal-body text-center">
          ...
          <div class="d-flex justify-content-center">
            ...
            <router-link to="/crm/deals-grid" class="btn btn-danger">Yes, Delete</router-link>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      Marketing: ["Select", "Sales", "Marketing", "Calls"],
      OpenWi: ["Select", "Open", "Won", "Lost"],
      USDEuro: ["Select", "USD", "Euro"],
      RoyLeis: ["Select", "Darlee Robertson", "Sharon Roy", "Vaughan Lewis"],
      offApp: [
        "Select",
      ...
      AssiInactive: ["Select", "Active", "Inactive"],
      EditKonospk: ["Select", "Collins", "Konopelski", "Adams"],
      EditMarketing: ["Select", "Sales", "Marketing", "Calls"],
      EditOpenWi: ["Select", "Open", "Won", "Lost"],
      EditUSDEuro: ["Select", "USD", "Euro"],
      EditRoyLeis: ["Select", "Darlee Robertson", "Sharon Roy", "Vaughan Lewis"],
      EditoffApp: [
        "Select",
        "Office Management App",
        "Clinic Management",
      ...
      EditAssiInactive: ["Select", "Active", "Inactive"],
      EditMediaGoo: ["Select", "Google", "Social Media"],
      MediaGoo: ["Select", "Google", "Social Media"],
      EditHigloMed: ["Select", "High", "Low", "Medium"],
      HigloMed: ["Select", "High", "Low", "Medium"],
    };
  },
  methods: {
    submitForm() {
