...
export default {
  data() {
    return {
      ...
      Termination: ["Select", "Retirement", "Insubordination", "Lack of Skills"],
  ...
  methods: {
    submitForm() {
      this.$router.push("/hrm/termination");
    },
  },
};
</script>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <vue-select :options="Terminated" id="villalobos" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Termination Type</label>
                  <vue-select :options="Termination" id="insubordination" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-12">
                <div class="mb-3">
          ...
          <div class="modal-body pb-0">
            <div class="row">
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Terminated Employee </label>
                  <vue-select :options="Terminated" id="villalobosone" placeholder="Anthony Lewis" />
                </div>
              </div>
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Termination Type</label>
                  <vue-select :options="Termination" id="insubordination-one" placeholder="Retirement" />
                </div>
              </div>
              <div class="col-md-12">
                <div class="mb-3">
      ...
      <div class="modal-content">
        <div class="modal-body text-center">
          ...
          <div class="d-flex justify-content-center">
            ...
            <router-link to="/hrm/termination" class="btn btn-danger">Yes, Delete</router-link>
          </div>
        </div>
      </div>
    </div>
